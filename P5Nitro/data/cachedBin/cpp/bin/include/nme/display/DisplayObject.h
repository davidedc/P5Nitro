...
class DisplayObject_obj : public ::nme::events::EventDispatcher_obj{
	...
	public:
		...
		Array< ::nme::filters::BitmapFilter > nmeFilters; /* REM */ 
		int nmeID; /* REM */ 
		...
		virtual Array< ::nme::filters::BitmapFilter > nmeSetFilters( Array< ::nme::filters::BitmapFilter > inFilters);
		Dynamic nmeSetFilters_dyn();

		virtual Array< ::nme::filters::BitmapFilter > nmeGetFilters( );
		...
		virtual ::nme::geom::Point globalToLocal( ::nme::geom::Point inLocal);
		Dynamic globalToLocal_dyn();

		virtual ::nme::geom::Point localToGlobal( ::nme::geom::Point inGlobal);
	...
	Dynamic &nme_create_display_object_dyn() { return nme_create_display_object;}
		static Dynamic nme_display_object_get_grapics; /* REM */ 
	Dynamic &nme_display_object_get_grapics_dyn() { return nme_display_object_get_grapics;}

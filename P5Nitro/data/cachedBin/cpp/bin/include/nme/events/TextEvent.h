...
class TextEvent_obj : public ::nme::events::Event_obj{
	public:
		...
		TextEvent_obj();
		Void __construct(::String type,Dynamic __o_bubbles,Dynamic __o_cancelable,Dynamic __o_inText);

	public:
		static hx::ObjectPtr< TextEvent_obj > __new(::String type,Dynamic __o_bubbles,Dynamic __o_cancelable,Dynamic __o_inText);

...
bool Reflect_obj::hasField( Dynamic o,::String field){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",30)
...
Dynamic Reflect_obj::field( Dynamic o,::String field){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",34)
...
Void Reflect_obj::setField( Dynamic o,::String field,Dynamic value){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",38)
		if (((o != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",39)
...
Dynamic Reflect_obj::callMethod( Dynamic o,Dynamic func,Array< Dynamic > args){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",43)
	if (((bool((func != null())) && bool((func->__GetType() == ::vtString)))))
		func = o->__Field(func);
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",45)
	func->__SetThis(o);
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",46)
...
Array< ::String > Reflect_obj::fields( Dynamic o){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",50)
	if (((o == null())))
		return Array_obj< ::String >::__new();
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",51)
	Array< ::String > a = Array_obj< ::String >::__new();
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",52)
	o->__GetFields(a);
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",53)
	return a;
}
...
bool Reflect_obj::isFunction( Dynamic f){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",57)
...
int Reflect_obj::compare( Dynamic a,Dynamic b){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",61)
...
bool Reflect_obj::compareMethods( Dynamic f1,Dynamic f2){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",65)
	if (((f1 == f2)))
		return true;
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",67)
	if (((bool(!(::Reflect_obj::isFunction(f1))) || bool(!(::Reflect_obj::isFunction(f2))))))
		return false;
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",69)
...
bool Reflect_obj::isObject( Dynamic v){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",73)
	if (((v == null())))
		return false;
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",74)
	int t = v->__GetType();
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",75)
...
bool Reflect_obj::deleteField( Dynamic o,::String f){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",80)
	if (((o == null())))
		return false;
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",81)
...
Dynamic Reflect_obj::copy( Dynamic o){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",85)
	if (((o == null())))
		return null();
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",86)
	if (((o->__GetType() == ::vtString)))
		return o;
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",87)
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",89)
	Dynamic o2 = _Function_1_1::Block();
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",90)
	{
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",90)
		int _g = (int)0;
		...
		while((_g < _g1->length)){
			...
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",90)
			++(_g);
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",91)
			if (((o2 != null()))){
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",91)
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",92)
	return o2;
}
...
Dynamic Reflect_obj::makeVarArgs( Dynamic f){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",96)

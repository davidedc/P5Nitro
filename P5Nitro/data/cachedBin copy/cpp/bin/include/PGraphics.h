...
class PGraphics_obj : public ::PImage_obj{
	public:
		typedef ::PImage_obj super;
		typedef PGraphics_obj OBJ_;
		PGraphics_obj();
		Void __construct(Dynamic x,Dynamic y);

	public:
		static hx::ObjectPtr< PGraphics_obj > __new(Dynamic x,Dynamic y);
		...
		::String __ToString() const { return HX_CSTRING("PGraphics"); }
		...
		virtual Void drawShapeToBitmapAndClearShape( );
		Dynamic drawShapeToBitmapAndClearShape_dyn();

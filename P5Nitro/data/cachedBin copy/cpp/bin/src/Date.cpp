...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",32)
...
double Date_obj::getTime( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",36)
...
int Date_obj::getHours( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",39)
...
int Date_obj::getMinutes( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",41)
...
int Date_obj::getSeconds( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",43)
...
int Date_obj::getFullYear( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",45)
...
int Date_obj::getMonth( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",47)
...
int Date_obj::getDate( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",49)
...
int Date_obj::getDay( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",51)
...
::String Date_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",53)
...
::Date Date_obj::now( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",56)
...
::Date Date_obj::fromTime( double t){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",60)
	::Date result = ::Date_obj::__new((int)0,(int)0,(int)0,(int)0,(int)0,(int)0);
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",61)
	result->mSeconds = (t * 0.001);
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",62)
	return result;
}
...
::Date Date_obj::fromString( ::String s){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",66)
	switch( (int)s.length){
		case (int)8: {
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",68)
			Array< ::String > k = s.split(HX_CSTRING(":"));
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",69)
			...
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",70)
			return d;
		}
		;break;
		case (int)10: {
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",72)
			Array< ::String > k = s.split(HX_CSTRING("-"));
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",73)
		...
		;break;
		case (int)19: {
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",75)
			Array< ::String > k = s.split(HX_CSTRING(" "));
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",76)
			Array< ::String > y = k->__get((int)0).split(HX_CSTRING("-"));
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",77)
			Array< ::String > t = k->__get((int)1).split(HX_CSTRING(":"));
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",78)
		...
		;break;
		default: {
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",81)
			hx::Throw ((HX_CSTRING("Invalid date format : ") + s));
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",83)
	return null();
}

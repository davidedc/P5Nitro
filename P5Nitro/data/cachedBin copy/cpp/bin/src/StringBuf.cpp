...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/std/StringBuf.hx",37)
...
Void StringBuf_obj::add( Dynamic x){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/StringBuf.hx",48)
...
Void StringBuf_obj::addSub( ::String s,int pos,Dynamic len){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/StringBuf.hx",64)
...
Void StringBuf_obj::addChar( int c){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/StringBuf.hx",75)
...
::String StringBuf_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/StringBuf.hx",89)

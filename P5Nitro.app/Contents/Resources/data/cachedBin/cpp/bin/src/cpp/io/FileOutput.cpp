...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileOutput.hx",36)
	this->__f = f;
}
;
	return null();
...
Void FileOutput_obj::writeByte( int c){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileOutput.hx",40)
		try{
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileOutput.hx",40)
...
int FileOutput_obj::writeBytes( ::haxe::io::Bytes s,int p,int l){
	...
	struct _Function_1_1{
		inline static int Block( ::cpp::io::FileOutput_obj *__this,::haxe::io::Bytes &s,int &p,int &l){
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileOutput.hx",44)
			try{
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileOutput.hx",44)
...
Void FileOutput_obj::flush( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileOutput.hx",48)
...
Void FileOutput_obj::close( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileOutput.hx",52)
		this->super::close();
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileOutput.hx",53)
...
Void FileOutput_obj::seek( int p,::cpp::io::FileSeek pos){
{
		...
		struct _Function_1_1{
			inline static int Block( ::cpp::io::FileSeek &pos){
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileOutput.hx",57)
				{
...
int FileOutput_obj::tell( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileOutput.hx",61)

...
bool Std_obj::is( Dynamic v,Dynamic t){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Std.hx",28)
...
::String Std_obj::string( Dynamic s){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Std.hx",32)
...
int Std_obj::_int( double x){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Std.hx",36)
	return ::__int__(x);
}
...
Dynamic Std_obj::parseInt( ::String x){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Std.hx",40)
...
double Std_obj::parseFloat( ::String x){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Std.hx",44)
...
int Std_obj::random( int x){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Std.hx",48)

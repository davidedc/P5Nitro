...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",31)
...
Void IntHash_obj::set( int key,Dynamic value){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",35)
...
Dynamic IntHash_obj::get( int key){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",39)
...
bool IntHash_obj::exists( int key){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",43)
...
bool IntHash_obj::remove( int key){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",47)
...
Dynamic IntHash_obj::keys( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",51)
	Array< int > a = ::__int_hash_keys(this->h);
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",52)
	return a->iterator();
}
...
Dynamic IntHash_obj::iterator( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",56)
	Array< Dynamic > a = ::__int_hash_values(this->h);
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",57)
	return a->iterator();
}
...
::String IntHash_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",61)
	::StringBuf s = ::StringBuf_obj::__new();
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",62)
	s->b[s->b->length] = HX_CSTRING("{");
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",63)
	Dynamic it = this->keys();
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",64)
	for(::cpp::FastIterator_obj< int > *__it = ::cpp::CreateFastIterator< int >(it);  __it->hasNext(); ){
		int i = __it->next();
		{
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",65)
			s->b[s->b->length] = i;
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",66)
			s->b[s->b->length] = HX_CSTRING(" => ");
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",67)
			s->b[s->b->length] = ::Std_obj::string(this->get(i));
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",68)
...
;
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",71)
	s->b[s->b->length] = HX_CSTRING("}");
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",72)

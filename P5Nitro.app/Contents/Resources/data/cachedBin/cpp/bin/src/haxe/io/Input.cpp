...
int Input_obj::readByte( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",37)
	hx::Throw (HX_CSTRING("Not implemented"));
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",38)
	return (int)0;
}
...
int Input_obj::readBytes( ::haxe::io::Bytes s,int pos,int len){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",45)
	int k = len;
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",46)
	Array< unsigned char > b = s->b;
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",47)
	if (((bool((bool((pos < (int)0)) || bool((len < (int)0)))) || bool(((pos + len) > s->length)))))
		hx::Throw (::haxe::io::Error_obj::OutsideBounds);
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",49)
	while((k > (int)0)){
		__SAFE_POINT
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",55)
		b[pos] = this->readByte();
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",59)
		(pos)++;
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",60)
		(k)--;
	}
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",62)
	return len;
}
...
bool Input_obj::setEndian( bool b){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",69)
	this->bigEndian = b;
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",70)
	return b;
}
...
::haxe::io::Bytes Input_obj::readAll( Dynamic bufsize){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",76)
	if (((bufsize == null())))
		bufsize = (int)16384;
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",82)
	::haxe::io::Bytes buf = ::haxe::io::Bytes_obj::alloc(bufsize);
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",83)
	::haxe::io::BytesBuffer total = ::haxe::io::BytesBuffer_obj::__new();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",84)
	try{
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",85)
		while(true){
			__SAFE_POINT
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",86)
			int len = this->readBytes(buf,(int)0,bufsize);
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",87)
			if (((len == (int)0)))
				hx::Throw (::haxe::io::Error_obj::Blocked);
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",89)
			{
				HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",89)
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",93)
...
Void Input_obj::readFullBytes( ::haxe::io::Bytes s,int pos,int len){
{
		...
		while((len > (int)0)){
			__SAFE_POINT
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",98)
			int k = this->readBytes(s,pos,len);
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",99)
			hx::AddEq(pos,k);
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",100)
			hx::SubEq(len,k);
		}
	}
return null();
...
::haxe::io::Bytes Input_obj::read( int nbytes){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",105)
	::haxe::io::Bytes s = ::haxe::io::Bytes_obj::alloc(nbytes);
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",106)
	int p = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",107)
	while((nbytes > (int)0)){
		__SAFE_POINT
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",108)
		int k = this->readBytes(s,p,nbytes);
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",109)
		if (((k == (int)0)))
			hx::Throw (::haxe::io::Error_obj::Blocked);
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",110)
		hx::AddEq(p,k);
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",111)
		hx::SubEq(nbytes,k);
	}
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",113)
	return s;
}
...
::String Input_obj::readUntil( int end){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",117)
	::StringBuf buf = ::StringBuf_obj::__new();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",118)
	int last;
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",119)
	while(((last = this->readByte()) != end)){
		__SAFE_POINT
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",120)
		buf->b[buf->b->length] = ::String::fromCharCode(last);
	}
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",121)
...
::String Input_obj::readLine( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",125)
	::StringBuf buf = ::StringBuf_obj::__new();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",126)
	int last;
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",127)
	::String s;
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",128)
	try{
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",129)
		while(((last = this->readByte()) != (int)10)){
			__SAFE_POINT
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",130)
			buf->b[buf->b->length] = ::String::fromCharCode(last);
		}
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",131)
		s = buf->b->join(HX_CSTRING(""));
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",132)
		...
		if (__e.IsClass< ::haxe::io::Eof >() ){
			::haxe::io::Eof e = __e;{
				HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",134)
				s = buf->b->join(HX_CSTRING(""));
				HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",135)
				if (((s.length == (int)0)))
					hx::Throw (e);
			}
		}
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",138)
	return s;
}
...
double Input_obj::readFloat( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",145)
...
double Input_obj::readDouble( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",159)
...
int Input_obj::readInt8( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",170)
	int n = this->readByte();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",171)
	if (((n >= (int)128)))
		return (n - (int)256);
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",173)
	return n;
}
...
int Input_obj::readInt16( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",177)
	int ch1 = this->readByte();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",178)
	int ch2 = this->readByte();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",179)
	int n = (  ((this->bigEndian)) ? int((int(ch2) | int((int(ch1) << int((int)8))))) : int((int(ch1) | int((int(ch2) << int((int)8))))) );
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",180)
	if (((((int(n) & int((int)32768))) != (int)0)))
		return (n - (int)65536);
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",182)
	return n;
}
...
int Input_obj::readUInt16( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",186)
	int ch1 = this->readByte();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",187)
	int ch2 = this->readByte();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",188)
...
int Input_obj::readInt24( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",192)
	int ch1 = this->readByte();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",193)
	int ch2 = this->readByte();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",194)
	int ch3 = this->readByte();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",195)
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",196)
	if (((((int(n) & int((int)8388608))) != (int)0)))
		return (n - (int)16777216);
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",198)
	return n;
}
...
int Input_obj::readUInt24( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",202)
	int ch1 = this->readByte();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",203)
	int ch2 = this->readByte();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",204)
	int ch3 = this->readByte();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",205)
...
int Input_obj::readInt31( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",209)
	int ch1;
	int ch2;
	int ch3;
	int ch4;
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",210)
	if ((this->bigEndian)){
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",211)
		ch4 = this->readByte();
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",212)
		ch3 = this->readByte();
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",213)
		ch2 = this->readByte();
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",214)
		ch1 = this->readByte();
	}
	else{
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",216)
		ch1 = this->readByte();
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",217)
		ch2 = this->readByte();
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",218)
		ch3 = this->readByte();
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",219)
		ch4 = this->readByte();
	}
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",221)
	if ((((((int(ch4) & int((int)128))) == (int)0) != ((((int(ch4) & int((int)64))) == (int)0)))))
		hx::Throw (::haxe::io::Error_obj::Overflow);
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",222)
...
int Input_obj::readUInt30( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",226)
	int ch1 = this->readByte();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",227)
	int ch2 = this->readByte();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",228)
	int ch3 = this->readByte();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",229)
	int ch4 = this->readByte();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",230)
	if (((((  ((this->bigEndian)) ? int(ch1) : int(ch4) )) >= (int)64)))
		hx::Throw (::haxe::io::Error_obj::Overflow);
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",231)
...
::cpp::CppInt32__ Input_obj::readInt32( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",235)
	int ch1 = this->readByte();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",236)
	int ch2 = this->readByte();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",237)
	int ch3 = this->readByte();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",238)
	int ch4 = this->readByte();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",239)
...
::String Input_obj::readString( int len){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",243)
	::haxe::io::Bytes b = ::haxe::io::Bytes_obj::alloc(len);
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",244)
	this->readFullBytes(b,(int)0,len);
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",248)
	return b->toString();
}

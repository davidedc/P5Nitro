...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/TouchEvent.hx",35)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/TouchEvent.hx",38)
	this->touchPointID = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/TouchEvent.hx",39)
...
::nme::events::MouseEvent TouchEvent_obj::nmeCreateSimilar( ::String inType,::nme::display::InteractiveObject related,::nme::display::InteractiveObject targ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/TouchEvent.hx",61)
	::nme::events::TouchEvent result = ::nme::events::TouchEvent_obj::__new(inType,this->bubbles,this->cancelable,this->localX,this->localY,(  (((related == null()))) ? ::nme::display::InteractiveObject(this->relatedObject) : ::nme::display::InteractiveObject(related) ),this->ctrlKey,this->altKey,this->shiftKey,this->buttonDown,this->delta,this->commandKey,this->clickCount);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/TouchEvent.hx",65)
	result->touchPointID = this->touchPointID;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/TouchEvent.hx",66)
	result->isPrimaryTouchPoint = this->isPrimaryTouchPoint;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/TouchEvent.hx",67)
	if (((targ != null())))
		result->target = targ;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/TouchEvent.hx",69)
	return result;
}
...
::nme::events::TouchEvent TouchEvent_obj::nmeCreate( ::String inType,Dynamic inEvent,::nme::geom::Point inLocal,::nme::display::InteractiveObject inTarget){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/TouchEvent.hx",45)
	int flags = inEvent->__Field(HX_CSTRING("flags"));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/TouchEvent.hx",46)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/TouchEvent.hx",52)
	evt->stageX = inEvent->__Field(HX_CSTRING("x"));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/TouchEvent.hx",53)
	evt->stageY = inEvent->__Field(HX_CSTRING("y"));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/TouchEvent.hx",54)
	evt->target = inTarget;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/TouchEvent.hx",55)
	return evt;
}

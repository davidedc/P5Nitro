...
bool FileSystem_obj::exists( ::String path){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",50)
...
Void FileSystem_obj::rename( ::String path,::String newpath){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",54)
...
Dynamic FileSystem_obj::stat( ::String path){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",59)
	Dynamic s = ::cpp::FileSystem_obj::sys_stat(path);
	struct _Function_1_1{
		inline static Dynamic Block( ){
			hx::Anon __result = hx::Anon_obj::Create();
			__result->Add(HX_CSTRING("gid") , (int)0);
			__result->Add(HX_CSTRING("uid") , (int)0);
			__result->Add(HX_CSTRING("atime") , ::Date_obj::fromTime((int)0));
			__result->Add(HX_CSTRING("mtime") , ::Date_obj::fromTime((int)0));
			__result->Add(HX_CSTRING("ctime") , ::Date_obj::fromTime((int)0));
			__result->Add(HX_CSTRING("dev") , (int)0);
			__result->Add(HX_CSTRING("ino") , (int)0);
			__result->Add(HX_CSTRING("nlink") , (int)0);
			__result->Add(HX_CSTRING("rdev") , (int)0);
			__result->Add(HX_CSTRING("size") , (int)0);
			__result->Add(HX_CSTRING("mode") , (int)0);
			return __result;
		}
	};
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",60)
	if (((s == null())))
		return _Function_1_1::Block();
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",62)
	s->__FieldRef(HX_CSTRING("atime")) = ::Date_obj::fromTime((1000.0 * s->__Field(HX_CSTRING("atime"))));
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",63)
	s->__FieldRef(HX_CSTRING("mtime")) = ::Date_obj::fromTime((1000.0 * s->__Field(HX_CSTRING("mtime"))));
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",64)
	s->__FieldRef(HX_CSTRING("ctime")) = ::Date_obj::fromTime((1000.0 * s->__Field(HX_CSTRING("ctime"))));
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",65)
	return s;
}
...
::String FileSystem_obj::fullPath( ::String relpath){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",69)
...
::cpp::FileKind FileSystem_obj::kind( ::String path){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",73)
	::String k = ::cpp::FileSystem_obj::sys_file_type(path);
	struct _Function_1_1{
		inline static ::cpp::FileKind Block( ::String &k){
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",74)
			::String _switch_1 = k;
			if (  ( _switch_1==HX_CSTRING("file"))){
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",75)
				return ::cpp::FileKind_obj::kfile;
			}
			else if (  ( _switch_1==HX_CSTRING("dir"))){
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",76)
				return ::cpp::FileKind_obj::kdir;
			}
			else  {
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",77)
...
bool FileSystem_obj::isDirectory( ::String path){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",82)
...
Void FileSystem_obj::createDirectory( ::String path){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",86)
...
Void FileSystem_obj::deleteFile( ::String path){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",91)
...
Void FileSystem_obj::deleteDirectory( ::String path){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",96)
...
Array< ::String > FileSystem_obj::readDirectory( ::String path){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",101)

...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/filters/BitmapFilter.hx",7)
	this->type = inType;
}
;
	return null();
...
::nme::filters::BitmapFilter BitmapFilter_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/filters/BitmapFilter.hx",11)
	hx::Throw (HX_CSTRING("clone not implemented"));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/filters/BitmapFilter.hx",12)
	return null();
}

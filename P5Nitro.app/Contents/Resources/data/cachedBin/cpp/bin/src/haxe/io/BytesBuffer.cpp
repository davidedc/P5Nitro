...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/BytesBuffer.hx",49)
...
Void BytesBuffer_obj::addByte( int byte){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/BytesBuffer.hx",63)
		this->b->push(byte);
	}
return null();
}
...
Void BytesBuffer_obj::add( ::haxe::io::Bytes src){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/BytesBuffer.hx",77)
		Array< unsigned char > b1 = this->b;
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/BytesBuffer.hx",78)
		Array< unsigned char > b2 = src->b;
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/BytesBuffer.hx",79)
		{
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/BytesBuffer.hx",79)
			int _g1 = (int)0;
			int _g = src->length;
			...
			while((_g1 < _g)){
				...
				HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/BytesBuffer.hx",79)
				int i = (_g1)++;
				HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/BytesBuffer.hx",80)
...
Void BytesBuffer_obj::addBytes( ::haxe::io::Bytes src,int pos,int len){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/BytesBuffer.hx",86)
		if (((bool((bool((pos < (int)0)) || bool((len < (int)0)))) || bool(((pos + len) > src->length)))))
			hx::Throw (::haxe::io::Error_obj::OutsideBounds);
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/BytesBuffer.hx",95)
		Array< unsigned char > b1 = this->b;
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/BytesBuffer.hx",96)
		Array< unsigned char > b2 = src->b;
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/BytesBuffer.hx",97)
		{
			...
			while((_g1 < _g)){
				...
				HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/BytesBuffer.hx",97)
				int i = (_g1)++;
				HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/BytesBuffer.hx",98)
				this->b->push(b2->__get(i));
			}
		}
	}
...
::haxe::io::Bytes BytesBuffer_obj::getBytes( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/BytesBuffer.hx",116)
	::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::__new(this->b->length,this->b);
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/BytesBuffer.hx",118)
	this->b = null();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/BytesBuffer.hx",119)
	return bytes;
}

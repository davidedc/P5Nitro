...
Void Output_obj::writeByte( int c){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",38)
...
int Output_obj::writeBytes( ::haxe::io::Bytes s,int pos,int len){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",42)
	int k = len;
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",43)
	Array< unsigned char > b = s->b;
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",45)
	if (((bool((bool((pos < (int)0)) || bool((len < (int)0)))) || bool(((pos + len) > s->length)))))
		hx::Throw (::haxe::io::Error_obj::OutsideBounds);
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",48)
	while((k > (int)0)){
		__SAFE_POINT
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",54)
		this->writeByte(b->__get(pos));
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",58)
		(pos)++;
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",59)
		(k)--;
	}
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",61)
	return len;
}
...
bool Output_obj::setEndian( bool b){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",71)
	this->bigEndian = b;
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",72)
	return b;
}
...
Void Output_obj::write( ::haxe::io::Bytes s){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",78)
		int l = s->length;
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",79)
		int p = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",80)
		while((l > (int)0)){
			__SAFE_POINT
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",81)
			int k = this->writeBytes(s,p,l);
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",82)
			if (((k == (int)0)))
				hx::Throw (::haxe::io::Error_obj::Blocked);
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",83)
			hx::AddEq(p,k);
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",84)
			hx::SubEq(l,k);
		}
	}
return null();
...
Void Output_obj::writeFullBytes( ::haxe::io::Bytes s,int pos,int len){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",89)
		while((len > (int)0)){
			__SAFE_POINT
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",90)
			int k = this->writeBytes(s,pos,len);
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",91)
			hx::AddEq(pos,k);
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",92)
			hx::SubEq(len,k);
		}
	}
return null();
...
Void Output_obj::writeFloat( double x){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",100)
...
Void Output_obj::writeDouble( double x){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",112)
...
Void Output_obj::writeInt8( int x){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",121)
		if (((bool((x < (int)-128)) || bool((x >= (int)128)))))
			hx::Throw (::haxe::io::Error_obj::Overflow);
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",123)
...
Void Output_obj::writeInt16( int x){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",127)
		if (((bool((x < (int)-32768)) || bool((x >= (int)32768)))))
			hx::Throw (::haxe::io::Error_obj::Overflow);
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",128)
...
Void Output_obj::writeUInt16( int x){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",132)
		if (((bool((x < (int)0)) || bool((x >= (int)65536)))))
			hx::Throw (::haxe::io::Error_obj::Overflow);
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",133)
		if ((this->bigEndian)){
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",134)
			this->writeByte((int(x) >> int((int)8)));
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",135)
			this->writeByte((int(x) & int((int)255)));
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",137)
			this->writeByte((int(x) & int((int)255)));
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",138)
			this->writeByte((int(x) >> int((int)8)));
		}
	}
return null();
...
Void Output_obj::writeInt24( int x){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",143)
		if (((bool((x < (int)-8388608)) || bool((x >= (int)8388608)))))
			hx::Throw (::haxe::io::Error_obj::Overflow);
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",144)
...
Void Output_obj::writeUInt24( int x){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",148)
		if (((bool((x < (int)0)) || bool((x >= (int)16777216)))))
			hx::Throw (::haxe::io::Error_obj::Overflow);
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",149)
		if ((this->bigEndian)){
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",150)
			this->writeByte((int(x) >> int((int)16)));
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",151)
			this->writeByte((int((int(x) >> int((int)8))) & int((int)255)));
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",152)
			this->writeByte((int(x) & int((int)255)));
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",154)
			this->writeByte((int(x) & int((int)255)));
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",155)
			this->writeByte((int((int(x) >> int((int)8))) & int((int)255)));
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",156)
			this->writeByte((int(x) >> int((int)16)));
		}
	}
return null();
...
Void Output_obj::writeInt31( int x){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",162)
		if (((bool((x < (int)-1073741824)) || bool((x >= (int)1073741824)))))
			hx::Throw (::haxe::io::Error_obj::Overflow);
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",164)
		if ((this->bigEndian)){
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",165)
			this->writeByte(hx::UShr(x,(int)24));
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",166)
			this->writeByte((int((int(x) >> int((int)16))) & int((int)255)));
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",167)
			this->writeByte((int((int(x) >> int((int)8))) & int((int)255)));
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",168)
			this->writeByte((int(x) & int((int)255)));
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",170)
			this->writeByte((int(x) & int((int)255)));
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",171)
			this->writeByte((int((int(x) >> int((int)8))) & int((int)255)));
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",172)
			this->writeByte((int((int(x) >> int((int)16))) & int((int)255)));
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",173)
			this->writeByte(hx::UShr(x,(int)24));
		}
	}
return null();
...
Void Output_obj::writeUInt30( int x){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",178)
		if (((bool((x < (int)0)) || bool((x >= (int)1073741824)))))
			hx::Throw (::haxe::io::Error_obj::Overflow);
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",179)
		if ((this->bigEndian)){
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",180)
			this->writeByte(hx::UShr(x,(int)24));
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",181)
			this->writeByte((int((int(x) >> int((int)16))) & int((int)255)));
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",182)
			this->writeByte((int((int(x) >> int((int)8))) & int((int)255)));
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",183)
			this->writeByte((int(x) & int((int)255)));
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",185)
			this->writeByte((int(x) & int((int)255)));
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",186)
			this->writeByte((int((int(x) >> int((int)8))) & int((int)255)));
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",187)
			this->writeByte((int((int(x) >> int((int)16))) & int((int)255)));
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",188)
			this->writeByte(hx::UShr(x,(int)24));
		}
	}
return null();
...
Void Output_obj::writeInt32( ::cpp::CppInt32__ x){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",193)
		if ((this->bigEndian)){
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",194)
			this->writeByte(::cpp::CppInt32___obj::toInt(::cpp::CppInt32___obj::ushr(x,(int)24)));
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",195)
			this->writeByte((int(::cpp::CppInt32___obj::toInt(::cpp::CppInt32___obj::ushr(x,(int)16))) & int((int)255)));
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",196)
			this->writeByte((int(::cpp::CppInt32___obj::toInt(::cpp::CppInt32___obj::ushr(x,(int)8))) & int((int)255)));
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",197)
			this->writeByte(::cpp::CppInt32___obj::toInt(::cpp::CppInt32___obj::_and(x,::cpp::CppInt32___obj::ofInt((int)255))));
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",199)
			this->writeByte(::cpp::CppInt32___obj::toInt(::cpp::CppInt32___obj::_and(x,::cpp::CppInt32___obj::ofInt((int)255))));
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",200)
			this->writeByte((int(::cpp::CppInt32___obj::toInt(::cpp::CppInt32___obj::ushr(x,(int)8))) & int((int)255)));
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",201)
			this->writeByte((int(::cpp::CppInt32___obj::toInt(::cpp::CppInt32___obj::ushr(x,(int)16))) & int((int)255)));
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",202)
			this->writeByte(::cpp::CppInt32___obj::toInt(::cpp::CppInt32___obj::ushr(x,(int)24)));
		}
	}
return null();
...
Void Output_obj::writeInput( ::haxe::io::Input i,Dynamic bufsize){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",216)
		if (((bufsize == null())))
			bufsize = (int)4096;
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",218)
		::haxe::io::Bytes buf = ::haxe::io::Bytes_obj::alloc(bufsize);
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",219)
		try{
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",220)
			while(true){
				__SAFE_POINT
				HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",221)
				int len = i->readBytes(buf,(int)0,bufsize);
				HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",222)
				if (((len == (int)0)))
					hx::Throw (::haxe::io::Error_obj::Blocked);
				HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",224)
				int p = (int)0;
				HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",225)
				while((len > (int)0)){
					__SAFE_POINT
					HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",226)
					int k = this->writeBytes(buf,p,len);
					HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",227)
					if (((k == (int)0)))
						hx::Throw (::haxe::io::Error_obj::Blocked);
					HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",229)
					hx::AddEq(p,k);
					HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",230)
					hx::SubEq(len,k);
				}
			}
		}
...
Void Output_obj::writeString( ::String s){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",241)
		::haxe::io::Bytes b = ::haxe::io::Bytes_obj::ofString(s);
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",243)

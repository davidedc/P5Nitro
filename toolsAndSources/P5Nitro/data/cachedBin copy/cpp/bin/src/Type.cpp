...
::Class Type_obj::getClass( Dynamic o){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",40)
	if (((bool((o == null())) || bool(!(::Reflect_obj::isObject(o))))))
		return null();
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",41)
	Dynamic c = o->__GetClass();
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",42)
	::String _switch_1 = c->toString();
	if (  ( _switch_1==HX_CSTRING("__Anon"))){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",44)
		return null();
	}
	else if (  ( _switch_1==HX_CSTRING("Class"))){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",45)
		return null();
	}
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",47)
	return c;
}
...
::Enum Type_obj::getEnum( Dynamic o){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",51)
	if (((o == null())))
		return null();
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",52)
	return o->__GetClass();
}
...
::Class Type_obj::getSuperClass( ::Class c){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",57)
	return c->GetSuper();
}
...
::String Type_obj::getClassName( ::Class c){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",61)
	if (((c == null())))
		return null();
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",63)
	return c->mName;
}
...
::String Type_obj::getEnumName( ::Enum e){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",67)
	return e->__ToString();
}
...
::Class Type_obj::resolveClass( ::String name){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",71)
	::Class result = ::Class_obj::Resolve(name);
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",72)
	if (((bool((result != null())) && bool(result->__IsEnum()))))
		return null();
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",74)
	return result;
}
...
::Enum Type_obj::resolveEnum( ::String name){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",78)
	::Class result = ::Class_obj::Resolve(name);
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",79)
	if (((bool((result != null())) && bool(!(result->__IsEnum())))))
		return null();
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",81)
	return result;
}
...
Dynamic Type_obj::createInstance( ::Class cl,Array< Dynamic > args){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",85)
	if (((cl != null())))
		return cl->mConstructArgs(args);
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",87)
	return null();
}
...
Dynamic Type_obj::createEmptyInstance( ::Class cl){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",91)
...
Dynamic Type_obj::createEnum( ::Enum e,::String constr,Array< Dynamic > params){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",95)
	if (((e->mConstructEnum != null())))
		return e->mConstructEnum(constr,params);
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",97)
	return null();
}
...
Dynamic Type_obj::createEnumIndex( ::Enum e,int index,Array< Dynamic > params){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",101)
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",103)
...
Array< ::String > Type_obj::getInstanceFields( ::Class c){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",107)
...
Array< ::String > Type_obj::getClassFields( ::Class c){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",111)
...
Array< ::String > Type_obj::getEnumConstructs( ::Enum e){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",115)
...
::ValueType Type_obj::_typeof( Dynamic v){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",119)
	if (((v == null())))
		return ::ValueType_obj::TNull;
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",120)
	int t = v->__GetType();
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",121)
	int _switch_2 = t;
	if (  ( _switch_2==::vtBool)){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",123)
		return ::ValueType_obj::TBool;
	}
	else if (  ( _switch_2==::vtInt)){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",124)
		return ::ValueType_obj::TInt;
	}
	else if (  ( _switch_2==::vtFloat)){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",125)
		return ::ValueType_obj::TFloat;
	}
	else if (  ( _switch_2==::vtFunction)){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",126)
		return ::ValueType_obj::TFunction;
	}
	else if (  ( _switch_2==::vtObject)){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",127)
		return ::ValueType_obj::TObject;
	}
	else if (  ( _switch_2==::vtEnum)){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",128)
		return ::ValueType_obj::TEnum(v->__GetClass());
	}
	else  {
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",130)
...
bool Type_obj::enumEq( Dynamic a,Dynamic b){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",135)
	return (a == b);
}
...
::String Type_obj::enumConstructor( Dynamic e){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",139)
	return e->__Tag();
}
...
Array< Dynamic > Type_obj::enumParameters( Dynamic e){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",143)
	Array< Dynamic > result = e->__EnumParams();
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",144)
	return (  (((result == null()))) ? Array< Dynamic >(Array_obj< Dynamic >::__new()) : Array< Dynamic >(result) );
}
...
int Type_obj::enumIndex( Dynamic e){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",148)
	return e->__Index();
}

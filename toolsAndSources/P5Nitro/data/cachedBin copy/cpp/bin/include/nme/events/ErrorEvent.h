...
class ErrorEvent_obj : public ::nme::events::TextEvent_obj{
	public:
		...
		ErrorEvent_obj();
		Void __construct(::String type,Dynamic __o_bubbles,Dynamic __o_cancelable,Dynamic __o_text,int inID);

	public:
		static hx::ObjectPtr< ErrorEvent_obj > __new(::String type,Dynamic __o_bubbles,Dynamic __o_cancelable,Dynamic __o_text,int inID);

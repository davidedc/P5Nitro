...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/display/ManagedStage.hx",48)
...
Void ManagedStage_obj::resize( int inWidth,int inHeight){
{
		...
		struct _Function_1_1{
			inline static Dynamic Block( int &inWidth,int &inHeight){
				...
				__result->Add(HX_CSTRING("type") , (int)8);
				__result->Add(HX_CSTRING("x") , inWidth);
				__result->Add(HX_CSTRING("y") , inHeight);
				return __result;
			}
		};
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/display/ManagedStage.hx",53)
...
Void ManagedStage_obj::nmeRender( bool inSendEnterFrame){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/display/ManagedStage.hx",58)
		this->beginRender();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/display/ManagedStage.hx",59)
		this->super::nmeRender(inSendEnterFrame);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/display/ManagedStage.hx",60)
		this->endRender();
	}
return null();
}
...
double ManagedStage_obj::nmeDoProcessStageEvent( Dynamic inEvent){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/display/ManagedStage.hx",65)
	this->nmePollTimers();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/display/ManagedStage.hx",66)
	double wake = this->super::nmeDoProcessStageEvent(inEvent);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/display/ManagedStage.hx",67)
	this->setNextWake(wake);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/display/ManagedStage.hx",68)
	return wake;
}
...
Void ManagedStage_obj::pumpEvent( Dynamic inEvent){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/display/ManagedStage.hx",73)
...
Void ManagedStage_obj::sendQuit( ){
{
		...
		struct _Function_1_1{
			inline static Dynamic Block( ){
				hx::Anon __result = hx::Anon_obj::Create();
				__result->Add(HX_CSTRING("type") , (int)10);
				return __result;
			}
		};
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/display/ManagedStage.hx",78)

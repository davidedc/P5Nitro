...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",19)
	super::__construct(null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",20)
	this->nmeTransform = (  (((sndTransform == null()))) ? ::nme::media::SoundTransform(null()) : ::nme::media::SoundTransform(sndTransform->clone()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",21)
	this->nmeHandle = ::nme::media::SoundChannel_obj::nme_sound_channel_create(inSoundHandle,startTime,loops,this->nmeTransform);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",22)
...
Void SoundChannel_obj::stop( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",26)
...
::nme::media::SoundTransform SoundChannel_obj::nmeGetTransform( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",30)
...
::nme::media::SoundTransform SoundChannel_obj::nmeSetTransform( ::nme::media::SoundTransform inTransform){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",34)
	this->nmeTransform = inTransform->clone();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",35)
	::nme::media::SoundChannel_obj::nme_sound_channel_set_transform(this->nmeHandle,this->nmeTransform);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",36)
	return inTransform;
}
...
double SoundChannel_obj::nmeGetLeft( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",39)
...
double SoundChannel_obj::nmeGetRight( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",40)
...
double SoundChannel_obj::nmeGetPosition( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",41)
...
bool SoundChannel_obj::nmeCheckComplete( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",45)
	if (((bool((this->nmeHandle != null())) && bool(::nme::media::SoundChannel_obj::nme_sound_channel_is_complete(this->nmeHandle))))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",47)
		this->nmeHandle = null();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",48)
		::nme::events::Event complete = ::nme::events::Event_obj::__new(::nme::events::Event_obj::SOUND_COMPLETE,null(),null());
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",49)
		this->dispatchEvent(complete);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",50)
		return true;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",52)
	return false;
}
...
Void SoundChannel_obj::nmePollComplete( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",57)
		if (((::nme::media::SoundChannel_obj::nmeIncompleteList->length > (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",59)
			Array< ::nme::media::SoundChannel > incomplete = Array_obj< ::nme::media::SoundChannel >::__new();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",60)
			{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",60)
				int _g = (int)0;
				...
				while((_g < _g1->length)){
					...
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",60)
					++(_g);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",61)
					if ((!(channel->nmeCheckComplete())))
						incomplete->push(channel);
				}
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",63)
...
bool SoundChannel_obj::nmeCompletePending( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundChannel.hx",69)

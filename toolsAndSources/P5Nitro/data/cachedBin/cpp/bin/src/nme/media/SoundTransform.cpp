...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundTransform.hx",10)
	this->volume = vol;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundTransform.hx",11)
	this->pan = panning;
}
;
	return null();
...
::nme::media::SoundTransform SoundTransform_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/media/SoundTransform.hx",15)

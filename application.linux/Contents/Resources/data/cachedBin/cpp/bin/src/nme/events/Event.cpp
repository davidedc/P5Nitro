...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/Event.hx",23)
	this->type = inType;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/Event.hx",24)
	this->bubbles = inBubbles;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/Event.hx",25)
	this->cancelable = inCancelable;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/Event.hx",26)
	this->nmeIsCancelled = false;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/Event.hx",27)
	this->nmeIsCancelledNow = false;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/Event.hx",28)
	this->target = null();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/Event.hx",29)
	this->currentTarget = null();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/Event.hx",30)
...
Void Event_obj::nmeSetPhase( int inPhase){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/Event.hx",15)
...
bool Event_obj::nmeGetIsCancelled( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/Event.hx",18)
...
::nme::events::Event Event_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/Event.hx",35)
...
Void Event_obj::stopImmediatePropagation( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/Event.hx",41)
		if ((this->cancelable))
...
Void Event_obj::stopPropagation( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/Event.hx",47)
		if ((this->cancelable))
...
::String Event_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/Event.hx",53)
	return this->type;
}

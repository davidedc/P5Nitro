...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/Point.hx",37)
	this->x = inX;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/Point.hx",38)
	this->y = inY;
}
;
	return null();
...
::nme::geom::Point Point_obj::add( ::nme::geom::Point v){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/Point.hx",43)
...
::nme::geom::Point Point_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/Point.hx",48)
...
bool Point_obj::equals( ::nme::geom::Point toCompare){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/Point.hx",53)
...
double Point_obj::get_length( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/Point.hx",59)
...
Void Point_obj::normalize( double thickness){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/Point.hx",63)
		if (((bool((this->x == (int)0)) && bool((this->y == (int)0))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/Point.hx",64)
			this->x = thickness;
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/Point.hx",67)
			double norm = (double(thickness) / double(::Math_obj::sqrt(((this->x * this->x) + (this->y * this->y)))));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/Point.hx",68)
			hx::MultEq(this->x,norm);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/Point.hx",69)
...
Void Point_obj::offset( double dx,double dy){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/Point.hx",75)
		hx::AddEq(this->x,dx);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/Point.hx",76)
		hx::AddEq(this->y,dy);
	}
return null();
}
...
::nme::geom::Point Point_obj::subtract( ::nme::geom::Point v){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/Point.hx",80)
...
double Point_obj::distance( ::nme::geom::Point pt1,::nme::geom::Point pt2){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/Point.hx",85)
	double dx = (pt1->x - pt2->x);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/Point.hx",86)
	double dy = (pt1->y - pt2->y);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/Point.hx",87)
...
::nme::geom::Point Point_obj::interpolate( ::nme::geom::Point pt1,::nme::geom::Point pt2,double f){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/Point.hx",92)
...
::nme::geom::Point Point_obj::polar( double len,double angle){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/Point.hx",98)

...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileInput.hx",36)
	this->__f = f;
}
;
	return null();
...
int FileInput_obj::readByte( ){
	...
	struct _Function_1_1{
		inline static int Block( ::cpp::io::FileInput_obj *__this){
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileInput.hx",40)
			try{
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileInput.hx",41)
				return ::cpp::io::FileInput_obj::file_read_char(__this->__f);
			}
			catch(Dynamic __e){
				{
					Dynamic e = __e;{
						HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileInput.hx",43)
...
int FileInput_obj::readBytes( ::haxe::io::Bytes s,int p,int l){
	...
	struct _Function_1_1{
		inline static int Block( ::cpp::io::FileInput_obj *__this,::haxe::io::Bytes &s,int &p,int &l){
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileInput.hx",51)
			try{
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileInput.hx",52)
				return ::cpp::io::FileInput_obj::file_read(__this->__f,s->b,p,l);
			}
			catch(Dynamic __e){
				{
					Dynamic e = __e;{
						HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileInput.hx",54)
						return (  ((e->__IsArray())) ? int(hx::Throw (::haxe::io::Eof_obj::__new())) : int(hx::Throw (::haxe::io::Error_obj::Custom(e))) );
					}
				}
			}
...
Void FileInput_obj::close( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileInput.hx",62)
		this->super::close();
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileInput.hx",63)
...
Void FileInput_obj::seek( int p,::cpp::io::FileSeek pos){
{
		...
		struct _Function_1_1{
			inline static int Block( ::cpp::io::FileSeek &pos){
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileInput.hx",67)
				{
...
int FileInput_obj::tell( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileInput.hx",71)
...
bool FileInput_obj::eof( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileInput.hx",76)

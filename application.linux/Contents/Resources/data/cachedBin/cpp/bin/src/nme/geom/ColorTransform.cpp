...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/ColorTransform.hx",30)
	this->redMultiplier = inRedMultiplier;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/ColorTransform.hx",31)
	this->greenMultiplier = inGreenMultiplier;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/ColorTransform.hx",32)
	this->blueMultiplier = inBlueMultiplier;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/ColorTransform.hx",33)
	this->alphaMultiplier = inAlphaMultiplier;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/ColorTransform.hx",34)
	this->redOffset = inRedOffset;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/ColorTransform.hx",35)
	this->greenOffset = inGreenOffset;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/ColorTransform.hx",36)
	this->blueOffset = inBlueOffset;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/ColorTransform.hx",37)
...
Void ColorTransform_obj::concat( ::nme::geom::ColorTransform second){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/ColorTransform.hx",41)
		hx::AddEq(this->redMultiplier,second->redMultiplier);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/ColorTransform.hx",42)
		hx::AddEq(this->greenMultiplier,second->greenMultiplier);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/ColorTransform.hx",43)
		hx::AddEq(this->blueMultiplier,second->blueMultiplier);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/geom/ColorTransform.hx",44)

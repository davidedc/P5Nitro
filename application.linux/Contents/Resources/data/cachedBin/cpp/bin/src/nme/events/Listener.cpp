...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/EventDispatcher.hx",16)
	this->mListner = inListener;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/EventDispatcher.hx",17)
	this->mUseCapture = inUseCapture;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/EventDispatcher.hx",18)
	this->mPriority = inPriority;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/EventDispatcher.hx",19)
...
bool Listener_obj::Is( Dynamic inListener,bool inCapture){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/EventDispatcher.hx",24)
...
Void Listener_obj::dispatchEvent( ::nme::events::Event event){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/events/EventDispatcher.hx",29)
		this->mListner(event);
	}
return null();
}

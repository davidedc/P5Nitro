...
Void PGraphics_obj::__construct(Dynamic x,Dynamic y)
{
{
	HX_SOURCE_POS("./PGraphics.hx",319)
	x = (  (((x == null()))) ? Dynamic((int)320) : Dynamic(x) );
	HX_SOURCE_POS("./PGraphics.hx",320)
	y = (  (((y == null()))) ? Dynamic((int)480) : Dynamic(y) );
	HX_SOURCE_POS("./PGraphics.hx",321)
	super::__construct(x,y);
	HX_SOURCE_POS("./PGraphics.hx",336)
	this->newShapeNeeded = true;
	HX_SOURCE_POS("./PGraphics.hx",340)
	this->pGraphicsAlpha = (int)0;
	HX_SOURCE_POS("./PGraphics.hx",342)
	this->PI = 3.141592;
	HX_SOURCE_POS("./PGraphics.hx",343)
	this->TWO_PI = ((int)2 * this->PI);
	HX_SOURCE_POS("./PGraphics.hx",344)
	this->HALF_PI = (double(this->PI) / double(2.0));
	HX_SOURCE_POS("./PGraphics.hx",345)
	this->P2D = (int)2;
	HX_SOURCE_POS("./PGraphics.hx",346)
	this->P3D = (int)3;
	HX_SOURCE_POS("./PGraphics.hx",347)
	this->CORNER = (int)0;
	HX_SOURCE_POS("./PGraphics.hx",348)
	this->RADIUS = (int)1;
	HX_SOURCE_POS("./PGraphics.hx",349)
	this->CENTER_RADIUS = (int)1;
	HX_SOURCE_POS("./PGraphics.hx",350)
	this->CENTER = (int)2;
	HX_SOURCE_POS("./PGraphics.hx",351)
	this->POLYGON = (int)2;
	HX_SOURCE_POS("./PGraphics.hx",352)
	this->QUADS = (int)5;
	HX_SOURCE_POS("./PGraphics.hx",353)
	this->TRIANGLES = (int)6;
	HX_SOURCE_POS("./PGraphics.hx",354)
	this->POINTS = (int)7;
	HX_SOURCE_POS("./PGraphics.hx",355)
	this->LINES = (int)8;
	HX_SOURCE_POS("./PGraphics.hx",356)
	this->TRIANGLE_STRIP = (int)9;
	HX_SOURCE_POS("./PGraphics.hx",357)
	this->TRIANGLE_FAN = (int)4;
	HX_SOURCE_POS("./PGraphics.hx",358)
	this->QUAD_STRIP = (int)3;
	HX_SOURCE_POS("./PGraphics.hx",359)
	this->CORNERS = (int)10;
	HX_SOURCE_POS("./PGraphics.hx",360)
	this->CLOSE = true;
	HX_SOURCE_POS("./PGraphics.hx",361)
	this->RGB = (int)1;
	HX_SOURCE_POS("./PGraphics.hx",362)
	this->HSB = (int)2;
	HX_SOURCE_POS("./PGraphics.hx",365)
	this->hasBackground = false;
	HX_SOURCE_POS("./PGraphics.hx",366)
	this->curRectMode = this->CORNER;
	HX_SOURCE_POS("./PGraphics.hx",367)
	this->curEllipseMode = this->CENTER;
	HX_SOURCE_POS("./PGraphics.hx",368)
	this->curShape = this->POLYGON;
	HX_SOURCE_POS("./PGraphics.hx",369)
	this->curShapeCount = (int)0;
	HX_SOURCE_POS("./PGraphics.hx",370)
	this->opacityRange = (int)255;
	HX_SOURCE_POS("./PGraphics.hx",371)
	this->redRange = (int)255;
	HX_SOURCE_POS("./PGraphics.hx",372)
	this->greenRange = (int)255;
	HX_SOURCE_POS("./PGraphics.hx",373)
	this->blueRange = (int)255;
	HX_SOURCE_POS("./PGraphics.hx",374)
	this->pathOpen = false;
	HX_SOURCE_POS("./PGraphics.hx",375)
	this->mousePressed = false;
	HX_SOURCE_POS("./PGraphics.hx",376)
	this->keyPressed = false;
	HX_SOURCE_POS("./PGraphics.hx",377)
	this->firstX = 0.0;
	HX_SOURCE_POS("./PGraphics.hx",378)
	this->firstY = 0.0;
	HX_SOURCE_POS("./PGraphics.hx",379)
	this->secondX = 0.0;
	HX_SOURCE_POS("./PGraphics.hx",380)
	this->secondY = 0.0;
	HX_SOURCE_POS("./PGraphics.hx",381)
	this->prevX = 0.0;
	HX_SOURCE_POS("./PGraphics.hx",382)
	this->prevY = 0.0;
	HX_SOURCE_POS("./PGraphics.hx",383)
	this->curColorMode = this->RGB;
	HX_SOURCE_POS("./PGraphics.hx",384)
	this->tintColor = (int)-1;
	HX_SOURCE_POS("./PGraphics.hx",385)
	this->curTextSize = (int)12;
	HX_SOURCE_POS("./PGraphics.hx",386)
	this->curTextFont = HX_CSTRING("Arial");
	HX_SOURCE_POS("./PGraphics.hx",390)
	this->doStroke = true;
	HX_SOURCE_POS("./PGraphics.hx",391)
	this->curStrokeWeight = (int)1;
	HX_SOURCE_POS("./PGraphics.hx",392)
	this->curStrokeColor = (int)-16777216;
	HX_SOURCE_POS("./PGraphics.hx",397)
	this->tint = false;
	HX_SOURCE_POS("./PGraphics.hx",400)
	this->doFill = true;
	HX_SOURCE_POS("./PGraphics.hx",401)
	this->curFillColor = (int)-1;
	HX_SOURCE_POS("./PGraphics.hx",409)
	this->shape = ::nme::display::Shape_obj::__new();
	HX_SOURCE_POS("./PGraphics.hx",411)
	this->shapeMatrix = ::nme::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
	HX_SOURCE_POS("./PGraphics.hx",412)
	this->doSmooth = false;
	HX_SOURCE_POS("./PGraphics.hx",417)
	this->trackingScaleX = 1.0;
	HX_SOURCE_POS("./PGraphics.hx",418)
	this->trackingScaleY = 1.0;
	HX_SOURCE_POS("./PGraphics.hx",419)
	this->trackingRotation = 0.0;
	HX_SOURCE_POS("./PGraphics.hx",420)
	this->trackingTranslationX = 0.0;
	HX_SOURCE_POS("./PGraphics.hx",421)
	this->trackingTranslationY = 0.0;
	HX_SOURCE_POS("./PGraphics.hx",423)
	this->matrixStack = Array_obj< ::nme::geom::Matrix >::__new();
	HX_SOURCE_POS("./PGraphics.hx",424)
	this->trackingScaleXStack = Array_obj< double >::__new();
	HX_SOURCE_POS("./PGraphics.hx",425)
	this->trackingScaleYStack = Array_obj< double >::__new();
	HX_SOURCE_POS("./PGraphics.hx",426)
	this->trackingRotationStack = Array_obj< double >::__new();
	HX_SOURCE_POS("./PGraphics.hx",427)
	this->trackingTranslationXStack = Array_obj< double >::__new();
	HX_SOURCE_POS("./PGraphics.hx",428)
	this->trackingTranslationYStack = Array_obj< double >::__new();
	HX_SOURCE_POS("./PGraphics.hx",430)
	this->curTightness = (int)0;
	HX_SOURCE_POS("./PGraphics.hx",431)
	this->curvePoints = Array_obj< ::nme::geom::Point >::__new();
	HX_SOURCE_POS("./PGraphics.hx",434)
	this->curBackground = this->colorArgCount1((int)214);
	HX_SOURCE_POS("./PGraphics.hx",437)
...
PGraphics_obj::~PGraphics_obj() { }

Dynamic PGraphics_obj::__CreateEmpty() { return  new PGraphics_obj; }
hx::ObjectPtr< PGraphics_obj > PGraphics_obj::__new(Dynamic x,Dynamic y)
{  hx::ObjectPtr< PGraphics_obj > result = new PGraphics_obj();
	result->__construct(x,y);
	return result;}

Dynamic PGraphics_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< PGraphics_obj > result = new PGraphics_obj();
	result->__construct(inArgs[0],inArgs[1]);
	return result;}

Void PGraphics_obj::ellipseModeArgCount1( int aEllipseMode){
{
		HX_SOURCE_PUSH("PGraphics_obj::ellipseModeArgCount1")
		HX_SOURCE_POS("./PGraphics.hx",169)
...
HX_DEFINE_DYNAMIC_FUNC1(PGraphics_obj,ellipseModeArgCount1,(void))

Void PGraphics_obj::smoothArgCount0( ){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::smoothArgCount0")
		HX_SOURCE_POS("./PGraphics.hx",179)
...
HX_DEFINE_DYNAMIC_FUNC0(PGraphics_obj,smoothArgCount0,(void))

Void PGraphics_obj::endDrawArgCount0( ){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::endDrawArgCount0")
		HX_SOURCE_POS("./PGraphics.hx",187)
		{
			HX_SOURCE_POS("./PGraphics.hx",187)
			{
				HX_SOURCE_POS("./PGraphics.hx",187)
				this->bitmapData->draw(this->shape,this->shapeMatrix,null(),null(),null(),true);
				HX_SOURCE_POS("./PGraphics.hx",187)
				this->shape->nmeGetGraphics()->clear();
			}
			HX_SOURCE_POS("./PGraphics.hx",187)
...
HX_DEFINE_DYNAMIC_FUNC0(PGraphics_obj,endDrawArgCount0,(void))

Void PGraphics_obj::beginDrawArgCount0( ){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::beginDrawArgCount0")
		HX_SOURCE_POS("./PGraphics.hx",219)
		{
			HX_SOURCE_POS("./PGraphics.hx",219)
		...
		HX_SOURCE_POS("./PGraphics.hx",223)
		if ((this->hasBackground)){
			HX_SOURCE_POS("./PGraphics.hx",225)
			this->backgroundArgCount0();
		}
	}
return null();
...
HX_DEFINE_DYNAMIC_FUNC0(PGraphics_obj,beginDrawArgCount0,(void))

double PGraphics_obj::sinArgCount1( double aNumber){
	__SAFE_POINT
	HX_SOURCE_PUSH("PGraphics_obj::sinArgCount1")
	HX_SOURCE_POS("./PGraphics.hx",230)
	return ::Math_obj::sin(aNumber);
}


HX_DEFINE_DYNAMIC_FUNC1(PGraphics_obj,sinArgCount1,return )

double PGraphics_obj::cosArgCount1( double aNumber){
	__SAFE_POINT
	HX_SOURCE_PUSH("PGraphics_obj::cosArgCount1")
	HX_SOURCE_POS("./PGraphics.hx",234)
	return ::Math_obj::cos(aNumber);
}


HX_DEFINE_DYNAMIC_FUNC1(PGraphics_obj,cosArgCount1,return )

double PGraphics_obj::randomArgCount2( double aMin,double aMax){
	__SAFE_POINT
	HX_SOURCE_PUSH("PGraphics_obj::randomArgCount2")
	HX_SOURCE_POS("./PGraphics.hx",238)
	return (aMin + (::Math_obj::random() * ((aMax - aMin))));
}


HX_DEFINE_DYNAMIC_FUNC2(PGraphics_obj,randomArgCount2,return )

Void PGraphics_obj::backgroundArgCount4( int r,int g,int b,int a){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::backgroundArgCount4")
		HX_SOURCE_POS("./PGraphics.hx",242)
		this->curBackground = this->colorArgCount4(r,g,b,a);
		HX_SOURCE_POS("./PGraphics.hx",248)
		this->bitmapData->fillRect(::nme::geom::Rectangle_obj::__new((int)0,(int)0,::Std_obj::_int(this->nmeGetWidth()),::Std_obj::_int(this->nmeGetHeight())),this->curBackground);
	}
return null();
}


HX_DEFINE_DYNAMIC_FUNC4(PGraphics_obj,backgroundArgCount4,(void))

Void PGraphics_obj::backgroundArgCount3( int r,int g,int b){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::backgroundArgCount3")
		HX_SOURCE_POS("./PGraphics.hx",253)
		this->curBackground = this->colorArgCount3(r,g,b);
		HX_SOURCE_POS("./PGraphics.hx",266)
		this->bitmapData->fillRect(::nme::geom::Rectangle_obj::__new((int)0,(int)0,::Std_obj::_int(this->nmeGetWidth()),::Std_obj::_int(this->nmeGetHeight())),this->curBackground);
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC3(PGraphics_obj,backgroundArgCount3,(void))

Void PGraphics_obj::backgroundArgCount2( int shadeOfGray,int a){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::backgroundArgCount2")
		HX_SOURCE_POS("./PGraphics.hx",271)
		this->curBackground = this->colorArgCount2(shadeOfGray,a);
		HX_SOURCE_POS("./PGraphics.hx",277)
		this->bitmapData->fillRect(::nme::geom::Rectangle_obj::__new((int)0,(int)0,::Std_obj::_int(this->nmeGetWidth()),::Std_obj::_int(this->nmeGetHeight())),this->curBackground);
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC2(PGraphics_obj,backgroundArgCount2,(void))

Void PGraphics_obj::backgroundArgCount1( int shadeOfGray){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::backgroundArgCount1")
		HX_SOURCE_POS("./PGraphics.hx",282)
		this->curBackground = this->colorArgCount1(shadeOfGray);
		HX_SOURCE_POS("./PGraphics.hx",295)
		this->bitmapData->fillRect(::nme::geom::Rectangle_obj::__new((int)0,(int)0,::Std_obj::_int(this->nmeGetWidth()),::Std_obj::_int(this->nmeGetHeight())),this->curBackground);
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC1(PGraphics_obj,backgroundArgCount1,(void))

Void PGraphics_obj::backgroundArgCount0( ){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::backgroundArgCount0")
		HX_SOURCE_POS("./PGraphics.hx",311)
		this->bitmapData->fillRect(::nme::geom::Rectangle_obj::__new((int)0,(int)0,::Std_obj::_int(this->nmeGetWidth()),::Std_obj::_int(this->nmeGetHeight())),this->curBackground);
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC0(PGraphics_obj,backgroundArgCount0,(void))

Void PGraphics_obj::imageArgCount3( ::PImage img,int x,int y){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::imageArgCount3")
		HX_SOURCE_POS("./PGraphics.hx",451)
		::nme::geom::Matrix keepingTheOriginalMatrix = this->shapeMatrix->clone();
		HX_SOURCE_POS("./PGraphics.hx",453)
		this->translateArgCount2(x,y);
		HX_SOURCE_POS("./PGraphics.hx",483)
		if ((this->tint)){
			HX_SOURCE_POS("./PGraphics.hx",484)
			int aa = (int((int(this->tintColor) >> int((int)24))) & int((int)255));
			HX_SOURCE_POS("./PGraphics.hx",485)
			int rr = (int((int(this->tintColor) >> int((int)16))) & int((int)255));
			HX_SOURCE_POS("./PGraphics.hx",486)
			int gg = (int((int(this->tintColor) >> int((int)8))) & int((int)255));
			HX_SOURCE_POS("./PGraphics.hx",487)
			int bb = (int(this->tintColor) & int((int)255));
			HX_SOURCE_POS("./PGraphics.hx",491)
			this->bitmapData->draw(img->bitmapData,this->shapeMatrix,::nme::geom::ColorTransform_obj::__new((double(bb) / double((int)255)),(double(gg) / double((int)255)),(double(rr) / double((int)255)),(double(aa) / double((int)255)),(int)0,(int)0,(int)0,(int)0),null(),null(),null());
		}
		else{
			HX_SOURCE_POS("./PGraphics.hx",500)
			this->bitmapData->draw(img->bitmapData,this->shapeMatrix,null(),null(),null(),null());
		}
		HX_SOURCE_POS("./PGraphics.hx",512)
...
HX_DEFINE_DYNAMIC_FUNC3(PGraphics_obj,imageArgCount3,(void))

Void PGraphics_obj::noTintArgCount0( ){
{
		HX_SOURCE_PUSH("PGraphics_obj::noTintArgCount0")
		HX_SOURCE_POS("./PGraphics.hx",516)
		this->tint = false;
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC0(PGraphics_obj,noTintArgCount0,(void))

Void PGraphics_obj::tintArgCount3( double rc,double gc,double bc){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::tintArgCount3")
		HX_SOURCE_POS("./PGraphics.hx",520)
		this->tint = true;
		HX_SOURCE_POS("./PGraphics.hx",521)
...
HX_DEFINE_DYNAMIC_FUNC3(PGraphics_obj,tintArgCount3,(void))

Void PGraphics_obj::tintArgCount4( double rc,double gc,double bc,double ac){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::tintArgCount4")
		HX_SOURCE_POS("./PGraphics.hx",526)
		this->tint = true;
		HX_SOURCE_POS("./PGraphics.hx",527)
...
HX_DEFINE_DYNAMIC_FUNC4(PGraphics_obj,tintArgCount4,(void))

::PGraphics PGraphics_obj::createGraphicsArgCount3( int w,int h,int type){
	__SAFE_POINT
	HX_SOURCE_PUSH("PGraphics_obj::createGraphicsArgCount3")
	HX_SOURCE_POS("./PGraphics.hx",541)
	::PGraphics thepGraphics = ::PGraphics_obj::__new(w,h);
	HX_SOURCE_POS("./PGraphics.hx",542)
	thepGraphics->nmeSetCacheAsBitmap(true);
	HX_SOURCE_POS("./PGraphics.hx",545)
	::nme::geom::Rectangle rect = ::nme::geom::Rectangle_obj::__new((int)0,(int)0,w,h);
	HX_SOURCE_POS("./PGraphics.hx",546)
	thepGraphics->bitmapData->fillRect(rect,(int)-16777216);
	HX_SOURCE_POS("./PGraphics.hx",547)
	return thepGraphics;
}


HX_DEFINE_DYNAMIC_FUNC3(PGraphics_obj,createGraphicsArgCount3,return )

int PGraphics_obj::redArgCount1( int aColor){
	HX_SOURCE_PUSH("PGraphics_obj::redArgCount1")
	HX_SOURCE_POS("./PGraphics.hx",551)
	return (int((int(aColor) >> int((int)16))) & int((int)255));
}


HX_DEFINE_DYNAMIC_FUNC1(PGraphics_obj,redArgCount1,return )

int PGraphics_obj::greenArgCount1( int aColor){
	HX_SOURCE_PUSH("PGraphics_obj::greenArgCount1")
	HX_SOURCE_POS("./PGraphics.hx",555)
	return (int((int(aColor) >> int((int)8))) & int((int)255));
}


HX_DEFINE_DYNAMIC_FUNC1(PGraphics_obj,greenArgCount1,return )

int PGraphics_obj::blueArgCount1( int aColor){
	HX_SOURCE_PUSH("PGraphics_obj::blueArgCount1")
	HX_SOURCE_POS("./PGraphics.hx",559)
	return (int(aColor) & int((int)255));
}


HX_DEFINE_DYNAMIC_FUNC1(PGraphics_obj,blueArgCount1,return )

int PGraphics_obj::alphaArgCount1( int aColor){
	HX_SOURCE_PUSH("PGraphics_obj::alphaArgCount1")
	HX_SOURCE_POS("./PGraphics.hx",563)
	return (int((int(aColor) >> int((int)24))) & int((int)255));
}


HX_DEFINE_DYNAMIC_FUNC1(PGraphics_obj,alphaArgCount1,return )

int PGraphics_obj::pGraphicsAlphaMethod( int aColor){
	HX_SOURCE_PUSH("PGraphics_obj::pGraphicsAlphaMethod")
	HX_SOURCE_POS("./PGraphics.hx",567)
	return (int((int(aColor) >> int((int)24))) & int((int)255));
}


HX_DEFINE_DYNAMIC_FUNC1(PGraphics_obj,pGraphicsAlphaMethod,return )

Void PGraphics_obj::drawShapeToBitmapAndClearShape( ){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::drawShapeToBitmapAndClearShape")
		HX_SOURCE_POS("./PGraphics.hx",572)
		this->bitmapData->draw(this->shape,this->shapeMatrix,null(),null(),null(),true);
		HX_SOURCE_POS("./PGraphics.hx",573)
		this->shape->nmeGetGraphics()->clear();
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC0(PGraphics_obj,drawShapeToBitmapAndClearShape,(void))

Void PGraphics_obj::beginShapeDrawing( ){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::beginShapeDrawing")
		HX_SOURCE_POS("./PGraphics.hx",595)
		{
			HX_SOURCE_POS("./PGraphics.hx",595)
			this->bitmapData->draw(this->shape,this->shapeMatrix,null(),null(),null(),true);
			HX_SOURCE_POS("./PGraphics.hx",595)
		...
		HX_SOURCE_POS("./PGraphics.hx",598)
		this->newShapeNeeded = false;
		HX_SOURCE_POS("./PGraphics.hx",605)
		if ((this->doStroke))
		...
		HX_SOURCE_POS("./PGraphics.hx",610)
		if ((this->doFill))
...
HX_DEFINE_DYNAMIC_FUNC0(PGraphics_obj,beginShapeDrawing,(void))

Void PGraphics_obj::endAnyOpenFills( ){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::endAnyOpenFills")
		HX_SOURCE_POS("./PGraphics.hx",617)
...
HX_DEFINE_DYNAMIC_FUNC0(PGraphics_obj,endAnyOpenFills,(void))

Void PGraphics_obj::lineArgCount4( Dynamic __o_x1,Dynamic __o_y1,Dynamic __o_x2,Dynamic __o_y2){
double x1 = __o_x1.Default(0);
double y1 = __o_y1.Default(0);
double x2 = __o_x2.Default(0);
double y2 = __o_y2.Default(0);
	HX_SOURCE_PUSH("PGraphics_obj::lineArgCount4");
{
		__SAFE_POINT
		HX_SOURCE_POS("./PGraphics.hx",623)
		if ((this->newShapeNeeded))
			this->beginShapeDrawing();
		HX_SOURCE_POS("./PGraphics.hx",624)
		this->shape->nmeGetGraphics()->moveTo(x1,y1);
		HX_SOURCE_POS("./PGraphics.hx",625)
...
HX_DEFINE_DYNAMIC_FUNC4(PGraphics_obj,lineArgCount4,(void))

Void PGraphics_obj::rectArgCount4( double x,double y,double width,double height){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::rectArgCount4")
		HX_SOURCE_POS("./PGraphics.hx",639)
		if ((this->doStroke)){
			HX_SOURCE_POS("./PGraphics.hx",640)
			hx::AddEq(x,this->curStrokeWeight);
			HX_SOURCE_POS("./PGraphics.hx",641)
			hx::AddEq(y,this->curStrokeWeight);
			HX_SOURCE_POS("./PGraphics.hx",642)
			hx::SubEq(width,this->curStrokeWeight);
			HX_SOURCE_POS("./PGraphics.hx",643)
			hx::SubEq(height,this->curStrokeWeight);
		}
		HX_SOURCE_POS("./PGraphics.hx",649)
		int _switch_1 = this->curRectMode;
		if (  ( _switch_1==this->CORNERS)){
			HX_SOURCE_POS("./PGraphics.hx",652)
			hx::SubEq(width,x);
			HX_SOURCE_POS("./PGraphics.hx",653)
			hx::SubEq(height,y);
		}
		else if (  ( _switch_1==this->RADIUS)){
			HX_SOURCE_POS("./PGraphics.hx",656)
			hx::MultEq(width,(int)2);
			HX_SOURCE_POS("./PGraphics.hx",657)
			hx::MultEq(height,(int)2);
		}
		else if (  ( _switch_1==this->CENTER)){
			HX_SOURCE_POS("./PGraphics.hx",659)
			hx::SubEq(x,(double(width) / double((int)2)));
			HX_SOURCE_POS("./PGraphics.hx",660)
...
;
;
		HX_SOURCE_POS("./PGraphics.hx",666)
		if ((this->newShapeNeeded))
			this->beginShapeDrawing();
		HX_SOURCE_POS("./PGraphics.hx",667)
...
HX_DEFINE_DYNAMIC_FUNC4(PGraphics_obj,rectArgCount4,(void))

Void PGraphics_obj::triangleArgCount6( double x1,double y1,double x2,double y2,double x3,double y3){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::triangleArgCount6")
		HX_SOURCE_POS("./PGraphics.hx",673)
		if ((this->newShapeNeeded))
			this->beginShapeDrawing();
		HX_SOURCE_POS("./PGraphics.hx",674)
		this->beginShapeArgCount0();
		HX_SOURCE_POS("./PGraphics.hx",675)
		this->vertexArgCount2(x1,y1);
		HX_SOURCE_POS("./PGraphics.hx",676)
		this->vertexArgCount2(x2,y2);
		HX_SOURCE_POS("./PGraphics.hx",677)
		this->vertexArgCount2(x3,y3);
		HX_SOURCE_POS("./PGraphics.hx",678)
...
HX_DEFINE_DYNAMIC_FUNC6(PGraphics_obj,triangleArgCount6,(void))

Void PGraphics_obj::ellipse( double x,double y,double width,double height){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::ellipse")
		HX_SOURCE_POS("./PGraphics.hx",686)
		hx::DivEq(width,(int)2);
		HX_SOURCE_POS("./PGraphics.hx",687)
		hx::DivEq(height,(int)2);
		HX_SOURCE_POS("./PGraphics.hx",689)
		int _switch_2 = this->curEllipseMode;
		if (  ( _switch_2==this->CORNER)){
			HX_SOURCE_POS("./PGraphics.hx",694)
			hx::AddEq(x,width);
			HX_SOURCE_POS("./PGraphics.hx",695)
			hx::AddEq(y,height);
		}
		else if (  ( _switch_2==this->RADIUS)){
			HX_SOURCE_POS("./PGraphics.hx",699)
			hx::MultEq(width,(int)2);
			HX_SOURCE_POS("./PGraphics.hx",700)
			hx::MultEq(height,(int)2);
		}
		else if (  ( _switch_2==this->CENTER)){
		}
		else if (  ( _switch_2==this->CORNERS)){
			HX_SOURCE_POS("./PGraphics.hx",707)
			hx::DivEq(width,(int)4);
			HX_SOURCE_POS("./PGraphics.hx",708)
			hx::DivEq(height,(int)4);
			HX_SOURCE_POS("./PGraphics.hx",709)
			hx::AddEq(x,width);
			HX_SOURCE_POS("./PGraphics.hx",710)
			hx::AddEq(y,height);
		}
		HX_SOURCE_POS("./PGraphics.hx",714)
		if ((this->newShapeNeeded))
			this->beginShapeDrawing();
		HX_SOURCE_POS("./PGraphics.hx",715)
...
HX_DEFINE_DYNAMIC_FUNC4(PGraphics_obj,ellipse,(void))

Void PGraphics_obj::noStrokeArgCount0( ){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::noStrokeArgCount0")
		HX_SOURCE_POS("./PGraphics.hx",720)
		this->doStroke = false;
		HX_SOURCE_POS("./PGraphics.hx",721)
...
HX_DEFINE_DYNAMIC_FUNC0(PGraphics_obj,noStrokeArgCount0,(void))

Void PGraphics_obj::strokeArgCount4( int r,int g,int b,int a){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::strokeArgCount4")
		HX_SOURCE_POS("./PGraphics.hx",726)
		this->doStroke = true;
		HX_SOURCE_POS("./PGraphics.hx",727)
		this->curStrokeColor = this->colorArgCount4(r,g,b,a);
		HX_SOURCE_POS("./PGraphics.hx",728)
		this->shape->nmeGetGraphics()->lineStyle(this->curStrokeWeight,(int(this->curStrokeColor) & int((int)16777215)),(double(this->pGraphicsAlphaMethod(this->curStrokeColor)) / double((int)255)),null(),::nme::display::LineScaleMode_obj::NONE,::nme::display::CapsStyle_obj::ROUND,null(),null());
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC4(PGraphics_obj,strokeArgCount4,(void))

Void PGraphics_obj::strokeArgCount3( int r,int g,int b){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::strokeArgCount3")
		HX_SOURCE_POS("./PGraphics.hx",734)
		this->doStroke = true;
		HX_SOURCE_POS("./PGraphics.hx",735)
		this->curStrokeColor = this->colorArgCount3(r,g,b);
		HX_SOURCE_POS("./PGraphics.hx",736)
		this->shape->nmeGetGraphics()->lineStyle(this->curStrokeWeight,(int(this->curStrokeColor) & int((int)16777215)),(double(this->pGraphicsAlphaMethod(this->curStrokeColor)) / double((int)255)),null(),::nme::display::LineScaleMode_obj::NONE,::nme::display::CapsStyle_obj::ROUND,null(),null());
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC3(PGraphics_obj,strokeArgCount3,(void))

Void PGraphics_obj::strokeArgCount2( int grayScale,int a){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::strokeArgCount2")
		HX_SOURCE_POS("./PGraphics.hx",742)
		this->doStroke = true;
		HX_SOURCE_POS("./PGraphics.hx",743)
		this->curStrokeColor = this->colorArgCount2(grayScale,a);
		HX_SOURCE_POS("./PGraphics.hx",744)
		this->shape->nmeGetGraphics()->lineStyle(this->curStrokeWeight,(int(this->curStrokeColor) & int((int)16777215)),(double(this->pGraphicsAlphaMethod(this->curStrokeColor)) / double((int)255)),null(),::nme::display::LineScaleMode_obj::NONE,::nme::display::CapsStyle_obj::ROUND,null(),null());
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC2(PGraphics_obj,strokeArgCount2,(void))

Void PGraphics_obj::strokeArgCount1( int grayScale){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::strokeArgCount1")
		HX_SOURCE_POS("./PGraphics.hx",750)
		this->doStroke = true;
		HX_SOURCE_POS("./PGraphics.hx",751)
		this->curStrokeColor = this->colorArgCount1(grayScale);
		HX_SOURCE_POS("./PGraphics.hx",752)
		this->shape->nmeGetGraphics()->lineStyle(this->curStrokeWeight,(int(this->curStrokeColor) & int((int)16777215)),(double(this->pGraphicsAlphaMethod(this->curStrokeColor)) / double((int)255)),null(),::nme::display::LineScaleMode_obj::NONE,::nme::display::CapsStyle_obj::ROUND,null(),null());
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC1(PGraphics_obj,strokeArgCount1,(void))

Void PGraphics_obj::noFillArgCount0( ){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::noFillArgCount0")
		HX_SOURCE_POS("./PGraphics.hx",758)
		this->doFill = false;
		HX_SOURCE_POS("./PGraphics.hx",759)
		this->shape->nmeGetGraphics()->endFill();
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC0(PGraphics_obj,noFillArgCount0,(void))

Void PGraphics_obj::fillArgCount4( int mr,int mg,int mb,int ma){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::fillArgCount4")
		HX_SOURCE_POS("./PGraphics.hx",764)
		this->doFill = true;
		HX_SOURCE_POS("./PGraphics.hx",765)
		this->curFillColor = this->colorArgCount4(mr,mg,mb,ma);
		HX_SOURCE_POS("./PGraphics.hx",766)
		this->shape->nmeGetGraphics()->beginFill((int(this->curFillColor) & int((int)16777215)),(double(this->pGraphicsAlphaMethod(this->curFillColor)) / double((int)255)));
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC4(PGraphics_obj,fillArgCount4,(void))

Void PGraphics_obj::fillArgCount3( int r,int g,int b){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::fillArgCount3")
		HX_SOURCE_POS("./PGraphics.hx",771)
		this->doFill = true;
		HX_SOURCE_POS("./PGraphics.hx",772)
		this->curFillColor = this->colorArgCount3(r,g,b);
		HX_SOURCE_POS("./PGraphics.hx",773)
...
HX_DEFINE_DYNAMIC_FUNC3(PGraphics_obj,fillArgCount3,(void))

Void PGraphics_obj::fillArgCount2( int grayScale,int a){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::fillArgCount2")
		HX_SOURCE_POS("./PGraphics.hx",778)
		this->doFill = true;
		HX_SOURCE_POS("./PGraphics.hx",779)
		this->curFillColor = this->colorArgCount2(grayScale,a);
		HX_SOURCE_POS("./PGraphics.hx",780)
		this->shape->nmeGetGraphics()->beginFill((int(this->curFillColor) & int((int)16777215)),(double(this->pGraphicsAlphaMethod(this->curFillColor)) / double((int)255)));
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC2(PGraphics_obj,fillArgCount2,(void))

Void PGraphics_obj::fillArgCount1( int grayScale){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::fillArgCount1")
		HX_SOURCE_POS("./PGraphics.hx",785)
		this->doFill = true;
		HX_SOURCE_POS("./PGraphics.hx",786)
		this->curFillColor = this->colorArgCount1(grayScale);
		HX_SOURCE_POS("./PGraphics.hx",787)
		this->shape->nmeGetGraphics()->beginFill((int(this->curFillColor) & int((int)16777215)),(double(this->pGraphicsAlphaMethod(this->curFillColor)) / double((int)255)));
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC1(PGraphics_obj,fillArgCount1,(void))

int PGraphics_obj::colorArgCount1( int shadeOfGray){
	__SAFE_POINT
	HX_SOURCE_PUSH("PGraphics_obj::colorArgCount1")
	HX_SOURCE_POS("./PGraphics.hx",793)
	int r = ::Std_obj::_int(((int)255 * ((double(shadeOfGray) / double(this->redRange)))));
	HX_SOURCE_POS("./PGraphics.hx",799)
	return (((((int(this->opacityRange) << int((int)24))) + ((int(r) << int((int)16)))) + ((int(r) << int((int)8)))) + r);
}


HX_DEFINE_DYNAMIC_FUNC1(PGraphics_obj,colorArgCount1,return )

int PGraphics_obj::colorArgCount2( int shadeOfGray,int a){
	__SAFE_POINT
	HX_SOURCE_PUSH("PGraphics_obj::colorArgCount2")
	HX_SOURCE_POS("./PGraphics.hx",804)
	int r = ::Std_obj::_int(((int)255 * ((double(shadeOfGray) / double(this->redRange)))));
	HX_SOURCE_POS("./PGraphics.hx",810)
	return (((((int(a) << int((int)24))) + ((int(r) << int((int)16)))) + ((int(r) << int((int)8)))) + r);
}


HX_DEFINE_DYNAMIC_FUNC2(PGraphics_obj,colorArgCount2,return )

int PGraphics_obj::colorArgCount3( int r,int g,int b){
	__SAFE_POINT
	HX_SOURCE_PUSH("PGraphics_obj::colorArgCount3")
	HX_SOURCE_POS("./PGraphics.hx",815)
	int r1 = ::Std_obj::_int(((int)255 * ((double(r) / double(this->redRange)))));
	HX_SOURCE_POS("./PGraphics.hx",816)
	int g1 = ::Std_obj::_int(((int)255 * ((double(g) / double(this->greenRange)))));
	HX_SOURCE_POS("./PGraphics.hx",817)
	int b1 = ::Std_obj::_int(((int)255 * ((double(b) / double(this->blueRange)))));
	HX_SOURCE_POS("./PGraphics.hx",830)
	return (((((int(this->opacityRange) << int((int)24))) + ((int(r1) << int((int)16)))) + ((int(g1) << int((int)8)))) + b1);
}


HX_DEFINE_DYNAMIC_FUNC3(PGraphics_obj,colorArgCount3,return )

int PGraphics_obj::colorArgCount4( int theR,int theG,int theB,int theA){
	__SAFE_POINT
	HX_SOURCE_PUSH("PGraphics_obj::colorArgCount4")
	HX_SOURCE_POS("./PGraphics.hx",836)
	int r = ::Std_obj::_int(((int)255 * ((double(theR) / double(this->redRange)))));
	HX_SOURCE_POS("./PGraphics.hx",837)
	int g = ::Std_obj::_int(((int)255 * ((double(theG) / double(this->greenRange)))));
	HX_SOURCE_POS("./PGraphics.hx",838)
	int b = ::Std_obj::_int(((int)255 * ((double(theB) / double(this->blueRange)))));
	HX_SOURCE_POS("./PGraphics.hx",839)
	int a = ::Std_obj::_int(((int)255 * ((double(theA) / double(this->opacityRange)))));
	HX_SOURCE_POS("./PGraphics.hx",852)
	return (((((int(a) << int((int)24))) + ((int(r) << int((int)16)))) + ((int(g) << int((int)8)))) + b);
}


HX_DEFINE_DYNAMIC_FUNC4(PGraphics_obj,colorArgCount4,return )

int PGraphics_obj::getColor( int aValue,int range){
	__SAFE_POINT
	HX_SOURCE_PUSH("PGraphics_obj::getColor")
	HX_SOURCE_POS("./PGraphics.hx",857)
	return ::Std_obj::_int(((int)255 * ((double(aValue) / double(range)))));
}


HX_DEFINE_DYNAMIC_FUNC2(PGraphics_obj,getColor,return )

Void PGraphics_obj::pushMatrixWithoutCreatingNewShape( ){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::pushMatrixWithoutCreatingNewShape")
		HX_SOURCE_POS("./PGraphics.hx",864)
		this->matrixStack->push(this->shapeMatrix);
		HX_SOURCE_POS("./PGraphics.hx",867)
		::nme::geom::Matrix newMatrix = this->shapeMatrix->clone();
		HX_SOURCE_POS("./PGraphics.hx",868)
		this->shapeMatrix = newMatrix;
		HX_SOURCE_POS("./PGraphics.hx",874)
		this->trackingScaleXStack->push(this->trackingScaleX);
		HX_SOURCE_POS("./PGraphics.hx",875)
		this->trackingScaleYStack->push(this->trackingScaleY);
		HX_SOURCE_POS("./PGraphics.hx",876)
		this->trackingRotationStack->push(this->trackingRotation);
		HX_SOURCE_POS("./PGraphics.hx",877)
		this->trackingTranslationXStack->push(this->trackingTranslationX);
		HX_SOURCE_POS("./PGraphics.hx",878)
		this->trackingTranslationYStack->push(this->trackingTranslationY);
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC0(PGraphics_obj,pushMatrixWithoutCreatingNewShape,(void))

Void PGraphics_obj::pushMatrixArgCount0( ){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::pushMatrixArgCount0")
		HX_SOURCE_POS("./PGraphics.hx",888)
		{
			HX_SOURCE_POS("./PGraphics.hx",888)
			this->matrixStack->push(this->shapeMatrix);
			HX_SOURCE_POS("./PGraphics.hx",888)
		...
		HX_SOURCE_POS("./PGraphics.hx",889)
		this->newShapeNeeded = true;
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC0(PGraphics_obj,pushMatrixArgCount0,(void))

Void PGraphics_obj::popMatrixWithoutCreatingNewShape( ){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::popMatrixWithoutCreatingNewShape")
		HX_SOURCE_POS("./PGraphics.hx",899)
		{
			HX_SOURCE_POS("./PGraphics.hx",899)
			this->bitmapData->draw(this->shape,this->shapeMatrix,null(),null(),null(),true);
			HX_SOURCE_POS("./PGraphics.hx",899)
		...
		HX_SOURCE_POS("./PGraphics.hx",902)
		this->trackingTranslationY = this->trackingTranslationYStack->pop();
		HX_SOURCE_POS("./PGraphics.hx",903)
		this->trackingTranslationX = this->trackingTranslationXStack->pop();
		HX_SOURCE_POS("./PGraphics.hx",904)
		this->trackingRotation = this->trackingRotationStack->pop();
		HX_SOURCE_POS("./PGraphics.hx",905)
		this->trackingScaleY = this->trackingScaleYStack->pop();
		HX_SOURCE_POS("./PGraphics.hx",906)
		this->trackingScaleX = this->trackingScaleXStack->pop();
		HX_SOURCE_POS("./PGraphics.hx",908)
		this->shapeMatrix = this->matrixStack->pop();
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC0(PGraphics_obj,popMatrixWithoutCreatingNewShape,(void))

Void PGraphics_obj::popMatrixArgCount0( ){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::popMatrixArgCount0")
		HX_SOURCE_POS("./PGraphics.hx",913)
		{
			HX_SOURCE_POS("./PGraphics.hx",913)
			{
				HX_SOURCE_POS("./PGraphics.hx",913)
		...
		HX_SOURCE_POS("./PGraphics.hx",914)
		this->newShapeNeeded = true;
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC0(PGraphics_obj,popMatrixArgCount0,(void))

Void PGraphics_obj::rotateArgCount1( double aAngle){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::rotateArgCount1")
		HX_SOURCE_POS("./PGraphics.hx",924)
		{
			HX_SOURCE_POS("./PGraphics.hx",924)
			this->bitmapData->draw(this->shape,this->shapeMatrix,null(),null(),null(),true);
			HX_SOURCE_POS("./PGraphics.hx",924)
		...
		HX_SOURCE_POS("./PGraphics.hx",927)
		::nme::geom::Matrix newMatrix = ::nme::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
		HX_SOURCE_POS("./PGraphics.hx",928)
		newMatrix->rotate(aAngle);
		HX_SOURCE_POS("./PGraphics.hx",929)
		newMatrix->concat(this->shapeMatrix);
		HX_SOURCE_POS("./PGraphics.hx",930)
		this->shapeMatrix = newMatrix;
		HX_SOURCE_POS("./PGraphics.hx",932)
		hx::AddEq(this->trackingRotation,aAngle);
		HX_SOURCE_POS("./PGraphics.hx",933)
		this->newShapeNeeded = true;
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC1(PGraphics_obj,rotateArgCount1,(void))

Void PGraphics_obj::scaleArgCount2( double x,double y){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::scaleArgCount2")
		HX_SOURCE_POS("./PGraphics.hx",942)
		{
			HX_SOURCE_POS("./PGraphics.hx",942)
			this->bitmapData->draw(this->shape,this->shapeMatrix,null(),null(),null(),true);
			HX_SOURCE_POS("./PGraphics.hx",942)
		...
		HX_SOURCE_POS("./PGraphics.hx",945)
		::nme::geom::Matrix newMatrix = ::nme::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
		HX_SOURCE_POS("./PGraphics.hx",946)
		newMatrix->scale(x,y);
		HX_SOURCE_POS("./PGraphics.hx",947)
		newMatrix->concat(this->shapeMatrix);
		HX_SOURCE_POS("./PGraphics.hx",948)
		this->shapeMatrix = newMatrix;
		HX_SOURCE_POS("./PGraphics.hx",950)
		hx::MultEq(this->trackingScaleX,x);
		HX_SOURCE_POS("./PGraphics.hx",951)
		hx::MultEq(this->trackingScaleY,y);
		HX_SOURCE_POS("./PGraphics.hx",953)
		this->newShapeNeeded = true;
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC2(PGraphics_obj,scaleArgCount2,(void))

Void PGraphics_obj::scaleArgCount1( double xy){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::scaleArgCount1")
		HX_SOURCE_POS("./PGraphics.hx",971)
		{
			HX_SOURCE_POS("./PGraphics.hx",971)
			this->bitmapData->draw(this->shape,this->shapeMatrix,null(),null(),null(),true);
			HX_SOURCE_POS("./PGraphics.hx",971)
		...
		HX_SOURCE_POS("./PGraphics.hx",974)
		::nme::geom::Matrix newMatrix = ::nme::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
		HX_SOURCE_POS("./PGraphics.hx",975)
		newMatrix->scale(xy,xy);
		HX_SOURCE_POS("./PGraphics.hx",976)
		newMatrix->concat(this->shapeMatrix);
		HX_SOURCE_POS("./PGraphics.hx",977)
		this->shapeMatrix = newMatrix;
		HX_SOURCE_POS("./PGraphics.hx",979)
		hx::MultEq(this->trackingScaleX,xy);
		HX_SOURCE_POS("./PGraphics.hx",980)
		hx::MultEq(this->trackingScaleY,xy);
		HX_SOURCE_POS("./PGraphics.hx",982)
		this->newShapeNeeded = true;
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC1(PGraphics_obj,scaleArgCount1,(void))

Void PGraphics_obj::translateArgCount2( double x,double y){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::translateArgCount2")
		HX_SOURCE_POS("./PGraphics.hx",990)
		{
			HX_SOURCE_POS("./PGraphics.hx",990)
			this->bitmapData->draw(this->shape,this->shapeMatrix,null(),null(),null(),true);
			HX_SOURCE_POS("./PGraphics.hx",990)
		...
		HX_SOURCE_POS("./PGraphics.hx",993)
		::nme::geom::Matrix newMatrix = ::nme::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
		HX_SOURCE_POS("./PGraphics.hx",994)
		newMatrix->translate(x,y);
		HX_SOURCE_POS("./PGraphics.hx",996)
		hx::AddEq(this->trackingTranslationX,x);
		HX_SOURCE_POS("./PGraphics.hx",997)
		hx::AddEq(this->trackingTranslationY,y);
		HX_SOURCE_POS("./PGraphics.hx",999)
		newMatrix->concat(this->shapeMatrix);
		HX_SOURCE_POS("./PGraphics.hx",1000)
		this->shapeMatrix = newMatrix;
		HX_SOURCE_POS("./PGraphics.hx",1002)
		this->newShapeNeeded = true;
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC2(PGraphics_obj,translateArgCount2,(void))

Void PGraphics_obj::strokeWeightArgCount1( double w){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::strokeWeightArgCount1")
		HX_SOURCE_POS("./PGraphics.hx",1007)
		this->curStrokeWeight = w;
		HX_SOURCE_POS("./PGraphics.hx",1009)
		if ((this->doStroke))
			this->shape->nmeGetGraphics()->lineStyle(this->curStrokeWeight,(int(this->curStrokeColor) & int((int)16777215)),(double(this->pGraphicsAlphaMethod(this->curStrokeColor)) / double((int)255)),null(),::nme::display::LineScaleMode_obj::NONE,::nme::display::CapsStyle_obj::ROUND,null(),null());
	}
return null();
...
HX_DEFINE_DYNAMIC_FUNC1(PGraphics_obj,strokeWeightArgCount1,(void))

Void PGraphics_obj::pointArgCount2( double x,double y){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::pointArgCount2")
		HX_SOURCE_POS("./PGraphics.hx",1019)
		::nme::geom::Point point = ::nme::geom::Point_obj::__new(null(),null());
		HX_SOURCE_POS("./PGraphics.hx",1020)
		point->x = x;
		HX_SOURCE_POS("./PGraphics.hx",1021)
		point->y = y;
		HX_SOURCE_POS("./PGraphics.hx",1024)
		::nme::geom::Point pointPosition;
		HX_SOURCE_POS("./PGraphics.hx",1025)
		pointPosition = this->shapeMatrix->transformPoint(point);
		HX_SOURCE_POS("./PGraphics.hx",1033)
		this->shape->nmeGetGraphics()->lineStyle(null(),null(),null(),null(),null(),null(),null(),null());
		HX_SOURCE_POS("./PGraphics.hx",1037)
		...
		HX_SOURCE_POS("./PGraphics.hx",1041)
		...
		HX_SOURCE_POS("./PGraphics.hx",1044)
		this->shape->nmeGetGraphics()->endFill();
		HX_SOURCE_POS("./PGraphics.hx",1051)
		this->bitmapData->draw(this->shape,null(),null(),null(),null(),this->doSmooth);
		HX_SOURCE_POS("./PGraphics.hx",1052)
		this->shape->nmeGetGraphics()->clear();
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC2(PGraphics_obj,pointArgCount2,(void))

Void PGraphics_obj::beginShapeArgCount0( ){
{
		HX_SOURCE_PUSH("PGraphics_obj::beginShapeArgCount0")
		HX_SOURCE_POS("./PGraphics.hx",1070)
		this->curShape = this->POLYGON;
		HX_SOURCE_POS("./PGraphics.hx",1071)
		this->curShapeCount = (int)0;
		HX_SOURCE_POS("./PGraphics.hx",1072)
		this->curvePoints = Array_obj< ::nme::geom::Point >::__new();
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC0(PGraphics_obj,beginShapeArgCount0,(void))

Void PGraphics_obj::beginShapeArgCount1( int type){
{
		HX_SOURCE_PUSH("PGraphics_obj::beginShapeArgCount1")
		HX_SOURCE_POS("./PGraphics.hx",1078)
		this->curShape = type;
		HX_SOURCE_POS("./PGraphics.hx",1079)
		this->curShapeCount = (int)0;
		HX_SOURCE_POS("./PGraphics.hx",1080)
		this->curvePoints = Array_obj< ::nme::geom::Point >::__new();
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC1(PGraphics_obj,beginShapeArgCount1,(void))

Void PGraphics_obj::endShapeArgCount0( ){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::endShapeArgCount0")
		HX_SOURCE_POS("./PGraphics.hx",1084)
		if (((bool((this->curShapeCount != (int)0)) || bool(this->pathOpen)))){
			HX_SOURCE_POS("./PGraphics.hx",1085)
			this->shape->nmeGetGraphics()->endFill();
			HX_SOURCE_POS("./PGraphics.hx",1086)
			this->curShapeCount = (int)0;
			HX_SOURCE_POS("./PGraphics.hx",1087)
			this->pathOpen = false;
			HX_SOURCE_POS("./PGraphics.hx",1101)
			if ((this->doFill))
				this->shape->nmeGetGraphics()->beginFill((int(this->curFillColor) & int((int)16777215)),(double(this->pGraphicsAlphaMethod(this->curFillColor)) / double((int)255)));
		}
	}
...
HX_DEFINE_DYNAMIC_FUNC0(PGraphics_obj,endShapeArgCount0,(void))

Void PGraphics_obj::endShapeArgCount1( bool close){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::endShapeArgCount1")
		HX_SOURCE_POS("./PGraphics.hx",1108)
		this->shape->nmeGetGraphics()->lineTo(this->firstX,this->firstY);
		HX_SOURCE_POS("./PGraphics.hx",1110)
		if (((bool((this->curShapeCount != (int)0)) || bool(this->pathOpen)))){
			HX_SOURCE_POS("./PGraphics.hx",1111)
			this->shape->nmeGetGraphics()->endFill();
			HX_SOURCE_POS("./PGraphics.hx",1112)
			this->curShapeCount = (int)0;
			HX_SOURCE_POS("./PGraphics.hx",1113)
			this->pathOpen = false;
		}
	}
return null();
...
HX_DEFINE_DYNAMIC_FUNC1(PGraphics_obj,endShapeArgCount1,(void))

Void PGraphics_obj::vertexArgCount2( double x,double y){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::vertexArgCount2")
		HX_SOURCE_POS("./PGraphics.hx",1119)
		if (((bool((this->curShapeCount == (int)0)) && bool((this->curShape != this->POINTS))))){
			HX_SOURCE_POS("./PGraphics.hx",1121)
			this->pathOpen = true;
			HX_SOURCE_POS("./PGraphics.hx",1122)
			if ((this->newShapeNeeded))
				this->beginShapeDrawing();
			HX_SOURCE_POS("./PGraphics.hx",1123)
			this->shape->nmeGetGraphics()->moveTo(x,y);
			HX_SOURCE_POS("./PGraphics.hx",1124)
			this->firstX = x;
			HX_SOURCE_POS("./PGraphics.hx",1125)
			this->firstY = y;
		}
		else{
			HX_SOURCE_POS("./PGraphics.hx",1129)
			if (((this->curShape == this->POINTS))){
				HX_SOURCE_POS("./PGraphics.hx",1131)
				this->pointArgCount2(x,y);
			}
			else{
				HX_SOURCE_POS("./PGraphics.hx",1134)
				if (((bool((this->curShape != this->QUAD_STRIP)) || bool((this->curShapeCount != (int)2)))))
					this->shape->nmeGetGraphics()->lineTo(x,y);
				HX_SOURCE_POS("./PGraphics.hx",1137)
				if (((this->curShape == this->TRIANGLE_STRIP))){
					HX_SOURCE_POS("./PGraphics.hx",1138)
					if (((this->curShapeCount == (int)2))){
						HX_SOURCE_POS("./PGraphics.hx",1140)
						this->endShapeArgCount1(this->CLOSE);
						HX_SOURCE_POS("./PGraphics.hx",1141)
						this->pathOpen = true;
						HX_SOURCE_POS("./PGraphics.hx",1142)
						if ((this->newShapeNeeded))
							this->beginShapeDrawing();
						HX_SOURCE_POS("./PGraphics.hx",1145)
						this->shape->nmeGetGraphics()->moveTo(this->prevX,this->prevY);
						HX_SOURCE_POS("./PGraphics.hx",1146)
						this->shape->nmeGetGraphics()->lineTo(x,y);
						HX_SOURCE_POS("./PGraphics.hx",1147)
						this->curShapeCount = (int)1;
					}
					HX_SOURCE_POS("./PGraphics.hx",1149)
					this->firstX = this->prevX;
					HX_SOURCE_POS("./PGraphics.hx",1150)
					this->firstY = this->prevY;
				}
				HX_SOURCE_POS("./PGraphics.hx",1153)
				if (((bool((this->curShape == this->TRIANGLE_FAN)) && bool((this->curShapeCount == (int)2))))){
					HX_SOURCE_POS("./PGraphics.hx",1155)
					this->endShapeArgCount1(this->CLOSE);
					HX_SOURCE_POS("./PGraphics.hx",1156)
					this->pathOpen = true;
					HX_SOURCE_POS("./PGraphics.hx",1157)
					if ((this->newShapeNeeded))
						this->beginShapeDrawing();
					HX_SOURCE_POS("./PGraphics.hx",1160)
					this->shape->nmeGetGraphics()->moveTo(this->firstX,this->firstY);
					HX_SOURCE_POS("./PGraphics.hx",1161)
					this->shape->nmeGetGraphics()->lineTo(x,y);
					HX_SOURCE_POS("./PGraphics.hx",1162)
					this->curShapeCount = (int)1;
				}
				HX_SOURCE_POS("./PGraphics.hx",1165)
				if (((bool((this->curShape == this->QUAD_STRIP)) && bool((this->curShapeCount == (int)3))))){
					HX_SOURCE_POS("./PGraphics.hx",1167)
					this->shape->nmeGetGraphics()->lineTo(this->prevX,this->prevY);
					HX_SOURCE_POS("./PGraphics.hx",1168)
					this->endShapeArgCount1(this->CLOSE);
					HX_SOURCE_POS("./PGraphics.hx",1169)
					this->pathOpen = true;
					HX_SOURCE_POS("./PGraphics.hx",1170)
					if ((this->newShapeNeeded))
						this->beginShapeDrawing();
					HX_SOURCE_POS("./PGraphics.hx",1173)
					this->shape->nmeGetGraphics()->moveTo(this->prevX,this->prevY);
					HX_SOURCE_POS("./PGraphics.hx",1174)
					this->shape->nmeGetGraphics()->lineTo(x,y);
					HX_SOURCE_POS("./PGraphics.hx",1175)
					this->curShapeCount = (int)1;
				}
				HX_SOURCE_POS("./PGraphics.hx",1178)
				if (((this->curShape == this->QUAD_STRIP))){
					HX_SOURCE_POS("./PGraphics.hx",1179)
					this->firstX = this->secondX;
					HX_SOURCE_POS("./PGraphics.hx",1180)
					this->firstY = this->secondY;
					HX_SOURCE_POS("./PGraphics.hx",1181)
					this->secondX = this->prevX;
					HX_SOURCE_POS("./PGraphics.hx",1182)
					this->secondY = this->prevY;
				}
			}
		}
		HX_SOURCE_POS("./PGraphics.hx",1201)
		this->prevX = x;
		HX_SOURCE_POS("./PGraphics.hx",1202)
		this->prevY = y;
		HX_SOURCE_POS("./PGraphics.hx",1203)
		(this->curShapeCount)++;
		HX_SOURCE_POS("./PGraphics.hx",1205)
		if (((bool((bool((bool((this->curShape == this->LINES)) && bool((this->curShapeCount == (int)2)))) || bool((bool((this->curShape == this->TRIANGLES)) && bool((this->curShapeCount == (int)3)))))) || bool((bool((this->curShape == this->QUADS)) && bool((this->curShapeCount == (int)4))))))){
			HX_SOURCE_POS("./PGraphics.hx",1208)
			this->endShapeArgCount1(this->CLOSE);
		}
	}
return null();
...
HX_DEFINE_DYNAMIC_FUNC2(PGraphics_obj,vertexArgCount2,(void))

Void PGraphics_obj::vertexArgCount4( double x,double y,double x2,double y2){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::vertexArgCount4")
		HX_SOURCE_POS("./PGraphics.hx",1213)
		if (((bool((this->curShapeCount == (int)0)) && bool((this->curShape != this->POINTS))))){
			HX_SOURCE_POS("./PGraphics.hx",1215)
			this->pathOpen = true;
			HX_SOURCE_POS("./PGraphics.hx",1216)
			if ((this->newShapeNeeded))
				this->beginShapeDrawing();
			HX_SOURCE_POS("./PGraphics.hx",1217)
			this->shape->nmeGetGraphics()->moveTo(x,y);
			HX_SOURCE_POS("./PGraphics.hx",1218)
			this->firstX = x;
			HX_SOURCE_POS("./PGraphics.hx",1219)
			this->firstY = y;
		}
		else{
			HX_SOURCE_POS("./PGraphics.hx",1223)
			if (((this->curShape == this->POINTS))){
				HX_SOURCE_POS("./PGraphics.hx",1225)
				this->pointArgCount2(x,y);
			}
			else{
				HX_SOURCE_POS("./PGraphics.hx",1228)
				if (((this->curShapeCount > (int)1))){
					HX_SOURCE_POS("./PGraphics.hx",1229)
					this->shape->nmeGetGraphics()->moveTo(this->prevX,this->prevY);
					HX_SOURCE_POS("./PGraphics.hx",1230)
					this->shape->nmeGetGraphics()->curveTo(this->firstX,this->firstY,x,y);
					HX_SOURCE_POS("./PGraphics.hx",1231)
					this->curShapeCount = (int)1;
				}
			}
		}
		HX_SOURCE_POS("./PGraphics.hx",1236)
		this->prevX = x;
		HX_SOURCE_POS("./PGraphics.hx",1237)
		this->prevY = y;
		HX_SOURCE_POS("./PGraphics.hx",1238)
		(this->curShapeCount)++;
		HX_SOURCE_POS("./PGraphics.hx",1240)
		if (((bool((bool((bool((this->curShape == this->LINES)) && bool((this->curShapeCount == (int)2)))) || bool((bool((this->curShape == this->TRIANGLES)) && bool((this->curShapeCount == (int)3)))))) || bool((bool((this->curShape == this->QUADS)) && bool((this->curShapeCount == (int)4))))))){
			HX_SOURCE_POS("./PGraphics.hx",1243)
			this->endShapeArgCount1(this->CLOSE);
		}
	}
return null();
...
HX_DEFINE_DYNAMIC_FUNC4(PGraphics_obj,vertexArgCount4,(void))

Void PGraphics_obj::vertexArgCount6( double x,double y,double x2,double y2,double x3,double y3){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::vertexArgCount6")
		HX_SOURCE_POS("./PGraphics.hx",1248)
		if (((bool((this->curShapeCount == (int)0)) && bool((this->curShape != this->POINTS))))){
			HX_SOURCE_POS("./PGraphics.hx",1250)
			this->pathOpen = true;
			HX_SOURCE_POS("./PGraphics.hx",1251)
			if ((this->newShapeNeeded))
				this->beginShapeDrawing();
			HX_SOURCE_POS("./PGraphics.hx",1252)
			this->shape->nmeGetGraphics()->moveTo(x,y);
			HX_SOURCE_POS("./PGraphics.hx",1253)
			this->firstX = x;
			HX_SOURCE_POS("./PGraphics.hx",1254)
			this->firstY = y;
		}
		else{
			HX_SOURCE_POS("./PGraphics.hx",1258)
			if (((this->curShape == this->POINTS))){
				HX_SOURCE_POS("./PGraphics.hx",1260)
				this->pointArgCount2(x,y);
			}
			else{
				HX_SOURCE_POS("./PGraphics.hx",1264)
				this->drawCubicBezier2(this->prevX,this->prevY,x,y,x2,y2,x3,y3);
				HX_SOURCE_POS("./PGraphics.hx",1267)
				x = x3;
				HX_SOURCE_POS("./PGraphics.hx",1268)
				y = y3;
			}
		}
		HX_SOURCE_POS("./PGraphics.hx",1272)
		this->prevX = x;
		HX_SOURCE_POS("./PGraphics.hx",1273)
		this->prevY = y;
		HX_SOURCE_POS("./PGraphics.hx",1274)
		(this->curShapeCount)++;
		HX_SOURCE_POS("./PGraphics.hx",1276)
		if (((bool((bool((bool((this->curShape == this->LINES)) && bool((this->curShapeCount == (int)2)))) || bool((bool((this->curShape == this->TRIANGLES)) && bool((this->curShapeCount == (int)3)))))) || bool((bool((this->curShape == this->QUADS)) && bool((this->curShapeCount == (int)4))))))){
			HX_SOURCE_POS("./PGraphics.hx",1279)
			this->endShapeArgCount1(this->CLOSE);
		}
	}
return null();
...
HX_DEFINE_DYNAMIC_FUNC6(PGraphics_obj,vertexArgCount6,(void))

Void PGraphics_obj::bezierVertexArgCount6( double x,double y,double x2,double y2,double x3,double y3){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::bezierVertexArgCount6")
		HX_SOURCE_POS("./PGraphics.hx",1284)
...
HX_DEFINE_DYNAMIC_FUNC6(PGraphics_obj,bezierVertexArgCount6,(void))

Void PGraphics_obj::curveVertexArgCount2( double x,double y){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::curveVertexArgCount2")
		HX_SOURCE_POS("./PGraphics.hx",1288)
		if (((this->curvePoints->length < (int)3))){
			HX_SOURCE_POS("./PGraphics.hx",1289)
			this->curvePoints->push(::nme::geom::Point_obj::__new(x,y));
		}
		else{
			HX_SOURCE_POS("./PGraphics.hx",1291)
			Array< Array< double > > b = Array_obj< Array< double > >::__new();
			HX_SOURCE_POS("./PGraphics.hx",1292)
			double s = ((int)1 - this->curTightness);
			HX_SOURCE_POS("./PGraphics.hx",1303)
			this->curvePoints->push(::nme::geom::Point_obj::__new(x,y));
			HX_SOURCE_POS("./PGraphics.hx",1305)
			b[(int)0] = Array_obj< double >::__new().Add(this->curvePoints->__get((int)1)->x).Add(this->curvePoints->__get((int)1)->y);
			HX_SOURCE_POS("./PGraphics.hx",1306)
			...
			HX_SOURCE_POS("./PGraphics.hx",1307)
			...
			HX_SOURCE_POS("./PGraphics.hx",1317)
...
HX_DEFINE_DYNAMIC_FUNC2(PGraphics_obj,curveVertexArgCount2,(void))

Void PGraphics_obj::curveTightness( double tightness){
{
		HX_SOURCE_PUSH("PGraphics_obj::curveTightness")
		HX_SOURCE_POS("./PGraphics.hx",1322)
...
HX_DEFINE_DYNAMIC_FUNC1(PGraphics_obj,curveTightness,(void))

Void PGraphics_obj::bezierArgCount8( double x1,double y1,double x2,double y2,double x3,double y3,double x4,double y4){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::bezierArgCount8")
		HX_SOURCE_POS("./PGraphics.hx",1328)
		if ((this->newShapeNeeded))
			this->beginShapeDrawing();
		HX_SOURCE_POS("./PGraphics.hx",1329)
		this->shape->nmeGetGraphics()->moveTo(x1,y1);
		HX_SOURCE_POS("./PGraphics.hx",1330)
		this->drawCubicBezier2(x1,y1,x2,y2,x3,y3,x4,y4);
		HX_SOURCE_POS("./PGraphics.hx",1331)
		this->shape->nmeGetGraphics()->endFill();
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC8(PGraphics_obj,bezierArgCount8,(void))

Void PGraphics_obj::drawCubicBezier2( double x1,double y1,double x2,double y2,double x3,double y3,double x4,double y4){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("PGraphics_obj::drawCubicBezier2")
		struct _Function_1_1{
			inline static ::nme::geom::Point Block( double &x2,double &y1,double &x1,double &y2){
				HX_SOURCE_POS("./PGraphics.hx",1351)
		...
		struct _Function_1_2{
			inline static ::nme::geom::Point Block( double &y4,double &x4,double &y3,double &x3){
				HX_SOURCE_POS("./PGraphics.hx",1352)
				double ratio = (double((int)3) / double((int)4));
				HX_SOURCE_POS("./PGraphics.hx",1352)
		...
		HX_SOURCE_POS("./PGraphics.hx",1355)
		double dx = (double(((x4 - x1))) / double((int)16));
		HX_SOURCE_POS("./PGraphics.hx",1356)
		double dy = (double(((y4 - y1))) / double((int)16));
		struct _Function_1_3{
			inline static ::nme::geom::Point Block( double &x2,double &y1,double &x1,double &y2){
				HX_SOURCE_POS("./PGraphics.hx",1359)
		...
		struct _Function_1_4{
			inline static ::nme::geom::Point Block( ::nme::geom::Point &PA,::nme::geom::Point &PB){
				HX_SOURCE_POS("./PGraphics.hx",1362)
				double x11 = PA->x;
				double y11 = PA->y;
				double ratio = (double((int)3) / double((int)8));
				HX_SOURCE_POS("./PGraphics.hx",1362)
		...
		HX_SOURCE_POS("./PGraphics.hx",1363)
		hx::SubEq(Pc_2->x,dx);
		HX_SOURCE_POS("./PGraphics.hx",1364)
		hx::SubEq(Pc_2->y,dy);
		struct _Function_1_5{
			inline static ::nme::geom::Point Block( ::nme::geom::Point &PB,::nme::geom::Point &PA){
				HX_SOURCE_POS("./PGraphics.hx",1367)
				double x11 = PB->x;
				double y11 = PB->y;
				double ratio = (double((int)3) / double((int)8));
				HX_SOURCE_POS("./PGraphics.hx",1367)
		...
		HX_SOURCE_POS("./PGraphics.hx",1368)
		hx::AddEq(Pc_3->x,dx);
		HX_SOURCE_POS("./PGraphics.hx",1369)
		hx::AddEq(Pc_3->y,dy);
		struct _Function_1_6{
			inline static ::nme::geom::Point Block( double &y4,double &x4,double &y3,double &x3){
				HX_SOURCE_POS("./PGraphics.hx",1372)
				double ratio = (double((int)3) / double((int)8));
				HX_SOURCE_POS("./PGraphics.hx",1372)
				return ::nme::geom::Point_obj::__new((x4 + (((x3 - x4)) * ratio)),(y4 + (((y3 - y4)) * ratio)));
			}
...
HX_DEFINE_DYNAMIC_FUNC8(PGraphics_obj,drawCubicBezier2,(void))

::nme::geom::Point PGraphics_obj::getMiddle( double x1,double y1,double x2,double y2){
	HX_SOURCE_PUSH("PGraphics_obj::getMiddle")
	HX_SOURCE_POS("./PGraphics.hx",1388)
	return ::nme::geom::Point_obj::__new((double(((x1 + x2))) / double((int)2)),(double(((y1 + y2))) / double((int)2)));
}


STATIC_HX_DEFINE_DYNAMIC_FUNC4(PGraphics_obj,getMiddle,return )

::nme::geom::Point PGraphics_obj::getPointOnSegment( double x1,double y1,double x2,double y2,double ratio){
	HX_SOURCE_PUSH("PGraphics_obj::getPointOnSegment")
	HX_SOURCE_POS("./PGraphics.hx",1394)
	return ::nme::geom::Point_obj::__new((x1 + (((x2 - x1)) * ratio)),(y1 + (((y2 - y1)) * ratio)));
}


STATIC_HX_DEFINE_DYNAMIC_FUNC5(PGraphics_obj,getPointOnSegment,return )
...
void PGraphics_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(PGraphics);
...
Dynamic PGraphics_obj::__Field(const ::String &inName)
{
	...
	case 25:
		...
		break;
	case 30:
		if (HX_FIELD_EQ(inName,"drawShapeToBitmapAndClearShape") ) { return drawShapeToBitmapAndClearShape_dyn(); }
		break;
	case 32:
...
Dynamic PGraphics_obj::__SetField(const ::String &inName,const Dynamic &inValue)
{
	switch(inName.length) {
	case 2:
...
void PGraphics_obj::__GetFields(Array< ::String> &outFields)
{
...
static ::String sMemberFields[] = {
	...
	HX_CSTRING("drawShapeToBitmapAndClearShape"),
...
Class PGraphics_obj::__mClass;

void PGraphics_obj::__register()
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("PGraphics"), hx::TCanCast< PGraphics_obj> ,sStaticFields,sMemberFields,
	&__CreateEmpty, &__Create,
	&super::__SGetClass(), 0, sMarkStatics);
}

void PGraphics_obj::__boot()
{
}

...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",33)
	this->length = length;
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",34)
	this->b = b;
}
;
	return null();
...
int Bytes_obj::get( int pos){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",45)
...
Void Bytes_obj::set( int pos,int v){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",59)
		this->b[pos] = v;
	}
return null();
}
...
Void Bytes_obj::blit( int pos,::haxe::io::Bytes src,int srcpos,int len){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",67)
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",78)
		Array< unsigned char > b1 = this->b;
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",79)
		Array< unsigned char > b2 = src->b;
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",80)
		if (((bool((b1 == b2)) && bool((pos > srcpos))))){
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",81)
			int i = len;
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",82)
			while((i > (int)0)){
				__SAFE_POINT
				HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",83)
				(i)--;
				HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",84)
				b1[(i + pos)] = b2->__get((i + srcpos));
			}
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",86)
			return null();
		}
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",88)
		{
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",88)
			int _g = (int)0;
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",88)
			while((_g < len)){
				...
				HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",88)
				int i = (_g)++;
				HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",89)
				b1[(i + pos)] = b2->__get((i + srcpos));
			}
		}
	}
...
::haxe::io::Bytes Bytes_obj::sub( int pos,int len){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",95)
	if (((bool((bool((pos < (int)0)) || bool((len < (int)0)))) || bool(((pos + len) > this->length)))))
		hx::Throw (::haxe::io::Error_obj::OutsideBounds);
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",108)
...
int Bytes_obj::compare( ::haxe::io::Bytes other){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",134)
	Array< unsigned char > b1 = this->b;
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",135)
	Array< unsigned char > b2 = other->b;
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",136)
	int len = (  (((this->length < other->length))) ? int(this->length) : int(other->length) );
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",137)
	{
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",137)
		int _g = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",137)
		while((_g < len)){
			...
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",137)
			int i = (_g)++;
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",138)
			if (((b1->__get(i) != b2->__get(i))))
				return (b1->__get(i) - b2->__get(i));
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",144)
...
::String Bytes_obj::readString( int pos,int len){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",150)
	if (((bool((bool((pos < (int)0)) || bool((len < (int)0)))) || bool(((pos + len) > this->length)))))
		hx::Throw (::haxe::io::Error_obj::OutsideBounds);
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",162)
	::String result = HX_CSTRING("");
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",163)
	::__hxcpp_string_of_bytes(this->b,result,pos,len);
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",164)
	return result;
}
...
::String Bytes_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",203)
...
Array< unsigned char > Bytes_obj::getData( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",208)
	return this->b;
}
...
::haxe::io::Bytes Bytes_obj::alloc( int length){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",228)
	Array< unsigned char > a = Array_obj< unsigned char >::__new();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",229)
	if (((length > (int)0)))
		a[(length - (int)1)] = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",230)
...
::haxe::io::Bytes Bytes_obj::ofString( ::String s){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",250)
	Array< unsigned char > a = Array_obj< unsigned char >::__new();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",251)
	::__hxcpp_bytes_of_string(a,s);
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",252)
...
::haxe::io::Bytes Bytes_obj::ofData( Array< unsigned char > b){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",286)

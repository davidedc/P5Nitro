...
Dynamic Lib_obj::load( ::String lib,::String prim,int nargs){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/Lib.hx",36)
...
Dynamic Lib_obj::loadLazy( Dynamic lib,Dynamic prim,int nargs){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/Lib.hx",45)
	try{
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/Lib.hx",46)
		return ::__loadprim(lib,prim,nargs);
	}
	catch(Dynamic __e){
		{
			Dynamic $t1 = __e;{
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/Lib.hx",47)
				Array< Dynamic > e = Array_obj< Dynamic >::__new().Add($t1);
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/Lib.hx",48)
				switch( (int)nargs){
					case (int)0: {
						...
						Void run(){
{
								HX_SOURCE_POS("/usr/lib/haxe/std/cpp/Lib.hx",49)
								hx::Throw (e->__get((int)0));
							}
							return null();
						}
...
{
								HX_SOURCE_POS("/usr/lib/haxe/std/cpp/Lib.hx",50)
								hx::Throw (e->__get((int)0));
							}
							return null();
						}
...
{
								HX_SOURCE_POS("/usr/lib/haxe/std/cpp/Lib.hx",51)
								hx::Throw (e->__get((int)0));
							}
							return null();
						}
...
{
								HX_SOURCE_POS("/usr/lib/haxe/std/cpp/Lib.hx",52)
								hx::Throw (e->__get((int)0));
							}
							return null();
						}
...
{
								HX_SOURCE_POS("/usr/lib/haxe/std/cpp/Lib.hx",53)
								hx::Throw (e->__get((int)0));
							}
							return null();
						}
					...
					default: {
						...
						Void run(Dynamic _1){
{
								HX_SOURCE_POS("/usr/lib/haxe/std/cpp/Lib.hx",54)
								hx::Throw (e->__get((int)0));
							}
							return null();
						}
...
Void Lib_obj::rethrow( Dynamic inExp){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/Lib.hx",59)
		hx::Throw (inExp);
	}
return null();
}
...
Void Lib_obj::stringReference( Dynamic inExp){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/Lib.hx",61)
		hx::Throw (inExp);
	}
return null();
}
...
Void Lib_obj::print( Dynamic v){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/Lib.hx",67)
		::__hxcpp_print(v);
	}
return null();
}
...
Dynamic Lib_obj::haxeToNeko( Dynamic v){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/Lib.hx",75)
	return v;
}
...
Dynamic Lib_obj::nekoToHaxe( Dynamic v){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/Lib.hx",83)
	return v;
}
...
Void Lib_obj::println( Dynamic v){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/Lib.hx",89)
		::__hxcpp_println(v);
	}
return null();
}

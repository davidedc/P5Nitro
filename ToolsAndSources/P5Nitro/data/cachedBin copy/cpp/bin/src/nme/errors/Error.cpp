...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/errors/Error.hx",11)
	this->message = inMessage;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/errors/Error.hx",12)
	this->errorID = id;
}
;
	return null();
...
::String Error_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/errors/Error.hx",14)
	return this->message;
}
...
::String Error_obj::getStackTrace( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/trunk/nme/errors/Error.hx",15)
	return HX_CSTRING("");
}

...
::String File_obj::getContent( ::String path){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/File.hx",41)
	::haxe::io::Bytes b = ::cpp::io::File_obj::getBytes(path);
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/File.hx",42)
	return b->toString();
}
...
::cpp::io::FileOutput File_obj::append( ::String path,bool binary){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/File.hx",59)
...
Void File_obj::copy( ::String src,::String dst){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/File.hx",63)
		::cpp::io::FileInput s = ::cpp::io::File_obj::read(src,true);
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/File.hx",64)
		::cpp::io::FileOutput d = ::cpp::io::File_obj::write(dst,true);
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/File.hx",65)
		d->writeInput(s,null());
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/File.hx",66)
		s->close();
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/File.hx",67)
		d->close();
	}
return null();
}
...
::cpp::io::FileInput File_obj::_stdin( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/File.hx",71)
...
::cpp::io::FileOutput File_obj::_stdout( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/File.hx",75)
...
::cpp::io::FileOutput File_obj::_stderr( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/File.hx",79)
...
int File_obj::getChar( bool echo){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/File.hx",83)
